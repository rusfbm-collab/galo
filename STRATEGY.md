...
**Category:** standalone world-model research architecture.
...
```text
problem with implicit agent state
→ verified bounded execution slice
→ broader architecture vision
→ recorded receipt walkthrough
→ scoped evidence and boundaries
→ partner-owned external evaluation
→ planned commercial route
→ founder and Abu Dhabi build plan
```

## Core objections

- **“Just an LLM wrapper?”** No model is positioned as GALO's authority; language/perception models are optional future adapters.
...
## Funnel and conversion goals

| Moment     | Visitor understanding                     | Interface goal                        |
| ---------- | ----------------------------------------- | ------------------------------------- |
| 10 seconds | Category, problem, and honest maturity    | Read hero and verified-slice strip    |
| 30 seconds | What is current vs target                 | Scan split architecture panel         |
| 90 seconds | How the receipt chain is inspected        | Complete recorded receipt walkthrough |
| 3 minutes  | Scope, wedge, roadmap, and Abu Dhabi plan | Reach evaluation section              |
| 10 minutes | Claim matrix and release fingerprint      | Inspect `/evidence`                   |

## Conversion hierarchy

1. `Inspect a verified receipt`
2. `Request a technical evaluation`
3. `Discuss an external evaluation design`
4. Conditional asset links only when real files exist

## Public release boundary

No engine source, raw consolidate, private manifests, absolute local paths, customer claims, partner logos, or unconfirmed personal data may enter the public repository.
