...
export const weightFreeRu: TranslationDictionary = {
  ...
  "A named relation between named things, carrying the observation it came from.":
    "Именованное отношение между именованными вещами — вместе с наблюдением, из которого оно взялось.",
  ...
  "A probabilistic answer": "Вероятностный ответ",
  "A procedure recorded as steps rather than as behaviour, versioned, and replayable as it stood.":
    "Процедура, записанная шагами, а не поведением, с версией, и воспроизводимая в том виде, в каком была.",
  "A reproducible answer": "Воспроизводимый ответ",
  "A structure that passed its formation checks, standing as active, weakened, or retired.":
    "Структура, прошедшая проверки образования, со статусом активной, ослабленной или выведенной из обращения.",
  ...
  "An AI architecture with no learned model weights and no backpropagation. GALO learns explicit relations and verified structures in a versioned Atlas, starting with industrial decision assurance. Scoped learning results are published together with their negatives; partner-controlled validity is not proven and production autonomy is not authorised.":
    "Архитектура ИИ без обучаемых весов модели и без обратного распространения ошибки. GALO выучивает явные отношения и проверенные структуры в версионируемом Атласе, начиная с подтверждения промышленных решений. Ограниченные по области результаты обучения публикуются вместе с отрицательными; валидность под контролем партнёра не доказана, промышленная автономия не разрешена.",
  ...
  "Both paths begin with data and end with an answer. They differ in one place: what the system keeps in between. A weight is a number that came out of training and carries no name; a structure is something that was named, checked, and written down before it was kept.":
    "Оба пути начинаются с данных и заканчиваются ответом. Различаются они в одном месте: тем, что система оставляет у себя посередине. Вес — это число, вышедшее из обучения и не имеющее имени; структура — это то, что назвали, проверили и записали, прежде чем оставить.",
  ...
  "Counters": "Счётчики",
  "Data": "Данные",
  "Data and experience": "Данные и опыт",
  "Discrete orders": "Дискретные порядки",
  ...
  "How often something has held up, kept as a whole number anybody can read and compare.":
    "Сколько раз что-то устояло, — целым числом, которое любой может прочитать и сравнить.",
  "If learning is not weights, here is the whole of what it is instead.":
    "Если обучение — это не веса, то вот полностью то, чем оно является вместо них.",
  ...
  "Know what changed, what it affects, and why the decision still stands.":
    "Знать, что изменилось, на что это влияет и почему решение всё ещё в силе.",
  "Local learning, and local revision.": "Локальное обучение и локальный пересмотр.",
  "Millions of numbers, none of them named": "Миллионы чисел, и ни у одного нет имени",
  ...
  "Neural AI learns by changing hidden numerical weights. GALO has no learned weights and uses no backpropagation. It learns by building, checking, reusing and locally revising explicit objects, relations, competing explanations and evidence in a versioned Atlas, so every learned change can be read, versioned and replayed. The first product applies that architecture to decision assurance around the digital twins and operational systems a plant already runs.":
    "Нейросетевой ИИ учится, меняя скрытые числовые веса. У GALO обучаемых весов нет, и обратное распространение ошибки не используется. Он учится иначе: строит, проверяет, переиспользует и локально пересматривает явные объекты, отношения, конкурирующие объяснения и свидетельства в версионируемом Атласе, так что каждое выученное изменение можно прочитать, версионировать и воспроизвести. Первый продукт применяет эту архитектуру к подтверждению решений вокруг цифровых двойников и операционных систем, которые на заводе уже работают.",
  ...
  "No learned weights and no backpropagation: what the engine learns is explicit and can be read, versioned and rolled back. The first product applies that to decision assurance around the systems a plant already runs. This page is the investment case: why this could be a company, what a cheque buys, what would unlock the next round, and the point at which the thesis should be called dead.":
    "Обучаемых весов нет, обратного распространения нет: выученное движком явно — его можно прочитать, версионировать и откатить. Первый продукт применяет это к подтверждению решений вокруг систем, которые на заводе уже работают. Эта страница — инвестиционный аргумент: почему из этого может выйти компания, что покупает чек, что откроет следующий раунд и в какой момент тезис следует считать мёртвым.",
  ...
  "Ordinary AI learns by changing hidden weights. This one has none to change.":
    "Обычный ИИ учится, меняя скрытые веса. Этому менять нечего.",
  ...
  "Six kinds of thing, and the list is complete rather than illustrative. Each one can be printed, compared with the same item from an earlier run, and rolled back on its own without touching the rest.":
    "Шесть видов, и список полный, а не для примера. Каждый можно распечатать, сравнить с тем же пунктом из прошлого прогона и откатить по отдельности, не трогая остальное.",
  ...
  "THE DIFFERENCE, BEFORE ANY NUMBERS": "РАЗЛИЧИЕ — ДО ВСЯКИХ ЦИФР",
  "TWO KINDS OF LEARNING": "ДВА ВИДА ОБУЧЕНИЯ",
  ...
  "Two columns of four boxes joined downward by arrows. The neural column runs from data to training to hidden numerical weights to a probabilistic answer. The GALO column runs from data and experience to explicit objects and relations to verified structures and routes to a reproducible answer. The third box in each column is marked, because that is the only step where the two differ.":
    "Две колонки по четыре блока, соединённые стрелками сверху вниз. Нейросетевая колонка идёт от данных к обучению, затем к скрытым числовым весам и к вероятностному ответу. Колонка GALO идёт от данных и опыта к явным объектам и отношениям, затем к проверенным структурам и маршрутам и к воспроизводимому ответу. Третий блок в каждой колонке помечен, потому что это единственный шаг, в котором они различаются.",
  "Verified structures and routes": "Проверенные структуры и маршруты",
  "WEIGHT-FREE AI · INDUSTRIAL DECISION ASSURANCE": "ИИ БЕЗ ОБУЧАЕМЫХ ВЕСОВ · ПОДТВЕРЖДЕНИЕ ПРОМЫШЛЕННЫХ РЕШЕНИЙ",
  "WHAT AN EPISODE MAY LEAVE BEHIND": "ЧТО ЭПИЗОД МОЖЕТ ОСТАВИТЬ ПОСЛЕ СЕБЯ",
  "What each kind of system keeps between data and answer":
    "Что каждый вид системы сохраняет между данными и ответом",
  ...
  "Which candidate to try first. An ordering of a declared list, not a score attached to it.":
    "Какого кандидата пробовать первым. Порядок на объявленном списке, а не оценка, приписанная к нему.",
  "Written-out routes": "Выписанные маршруты",
  "marked: the one step where the two differ": "помечено: единственный шаг, в котором они различаются",
};
...
export const weightFreeZh: TranslationDictionary = {
  ...
  "A probabilistic answer": "一个概率性的答案",
  "A procedure recorded as steps rather than as behaviour, versioned, and replayable as it stood.":
    "以步骤而不是以行为记录下来的过程，带版本，并且可以按它当时的样子重放。",
  "A reproducible answer": "一个可复现的答案",
  "A structure that passed its formation checks, standing as active, weakened, or retired.":
    "通过了形成检查的结构，标着「有效」「被削弱」或「已退役」。",
  "A system is shown a great many examples, and while it looks at them it quietly adjusts millions of internal numbers until the answers come out about right. Those numbers are what it learned. None of them means anything on its own, so when you ask why, the honest reply is often that this is how it came out inside.":
  ...
  "An AI architecture with no learned model weights and no backpropagation. GALO learns explicit relations and verified structures in a versioned Atlas, starting with industrial decision assurance. Scoped learning results are published together with their negatives; partner-controlled validity is not proven and production autonomy is not authorised.":
    "一种没有已学权重、也不使用反向传播的人工智能架构。GALO 在带版本的 Atlas 中学习显式的关系与已验证的结构，并以工业决策保障作为起点。范围受限的学习结果连同其负面结果一并公布；由合作方控制的有效性尚未得到证明，生产环境的自主权未获授权。",
  ...
  "Both paths begin with data and end with an answer. They differ in one place: what the system keeps in between. A weight is a number that came out of training and carries no name; a structure is something that was named, checked, and written down before it was kept.":
    "两条路都从数据开始，都以一个答案结束。它们只在一个地方不同：系统在中间保留了什么。权重是训练过程中出来的一个数字，它没有名字；结构则是先被命名、被检查、被写下来，然后才被保留的东西。",
  "By building, checking, reusing and locally revising explicit structures. There is no parameter tensor to adjust, no gradient step and no backpropagation anywhere in the engine.":
  ...
  "Counters": "计数器",
  "Data": "数据",
  "Data and experience": "数据与经验",
  "Discrete orders": "离散的次序",
  "Everything further down this page — the percentages, the receipts, the seven phases, the tables — is evidence about a kind of object. This section says what the object is, because the evidence does not mean much until that is clear.":
  ...
  "How it learns": "它如何学习",
  "How often something has held up, kept as a whole number anybody can read and compare.":
    "某件事情站住脚的次数，记成一个任何人都能读、都能比较的整数。",
  "If learning is not weights, here is the whole of what it is instead.": "如果学习不是权重，那么它是什么——下面是完整的清单。",
  ...
  "Know what changed, what it affects, and why the decision still stands.": "知道什么变了、它影响到哪些决策，以及为什么这个决定仍然成立。",
  "Local learning, and local revision.": "就地学习，就地修订。",
  "Millions of numbers, none of them named": "几百万个数字，没有一个有名字",
  "NEURAL AI": "神经网络人工智能",
  "Neither column is a verdict on the other. They are two ways of arriving at an answer, and the thing each one keeps along the way is what makes them different afterwards.":
    "两栏都不是对另一栏的判决。它们是抵达答案的两种方式，而事后把它们区分开来的，正是各自一路上保留下来的东西。",
  "Neural AI learns by changing hidden numerical weights. GALO has no learned weights and uses no backpropagation. It learns by building, checking, reusing and locally revising explicit objects, relations, competing explanations and evidence in a versioned Atlas, so every learned change can be read, versioned and replayed. The first product applies that architecture to decision assurance around the digital twins and operational systems a plant already runs.":
    "神经网络人工智能靠改变隐藏的数值权重来学习。GALO 没有已学权重，也不使用反向传播。它的学习方式是另一种：在带版本的 Atlas 中构建、检查、复用并就地修订显式的对象、关系、相互竞争的解释和证据，因此每一次学到的改动都可以被读取、被版本化、被重放。第一款产品把这套架构用在决策保障上，围绕工厂已经在运行的数字孪生与运营系统。",
  "Neural AI learns weights. GALO learns structures.": "神经网络学的是权重。GALO 学的是结构。",
  "No learned weights and no backpropagation: what the engine learns is explicit and can be read, versioned and rolled back. The first product applies that to decision assurance around the systems a plant already runs. This page is the investment case: why this could be a company, what a cheque buys, what would unlock the next round, and the point at which the thesis should be called dead.":
    "没有已学权重，也没有反向传播：引擎学到的东西是显式的，可以被读取、被版本化、被回滚。第一款产品把这一点用在决策保障上，围绕工厂已经在运行的系统。本页是投资论证：为什么这件事可能成为一家公司、一张支票买到的是什么、什么能打开下一轮，以及在哪个节点应当宣布这个论点已死。",
  "No learned weights. No backpropagation.": "没有已学权重。没有反向传播。",
  "One learns by changing hidden numbers. This one has no numbers to change.": "一种靠改变隐藏的数字来学习。这一种没有可改的数字。",
  "Ordinary AI learns by changing hidden weights. This one has none to change.": "普通的人工智能靠改变隐藏权重来学习。这一种没有可改的权重。",
  "Ordinary AI learns by changing millions of hidden numbers. This one learns by changing things that are written down.":
  ...
  "Six kinds of thing, and the list is complete rather than illustrative. Each one can be printed, compared with the same item from an earlier run, and rolled back on its own without touching the rest.":
    "六类东西，而且这份清单是完整的，不是举例说明。每一类都可以打印出来，与上一次运行中的同一项作比较，并且可以单独回滚而不动其余的部分。",
  "Static scan of the active import closure, run by the project": "对活跃导入闭包的静态扫描，由本项目自行执行",
  "THE DIFFERENCE, BEFORE ANY NUMBERS": "先说差别，再谈数字",
  "TWO KINDS OF LEARNING": "两种学习方式",
  "The architecture is meant to be general, and it is weight-free: nothing it learns is a hidden number, so an affected decision can be named rather than inferred. The first product is deliberately narrow — one industrial workflow, read only, advisory, with a frozen baseline and a decision package somebody else can replay. Industry is where the cost of ambiguity is already counted, which is why an architecture is worth testing there first.":
  ...
  "Two columns of four boxes joined downward by arrows. The neural column runs from data to training to hidden numerical weights to a probabilistic answer. The GALO column runs from data and experience to explicit objects and relations to verified structures and routes to a reproducible answer. The third box in each column is marked, because that is the only step where the two differ.":
    "两栏，每栏四个方框，用向下的箭头相连。神经网络那一栏从数据到训练，再到隐藏的数值权重，最后是一个概率性的答案。GALO 那一栏从数据与经验到显式的对象与关系，再到已验证的结构与路线，最后是一个可复现的答案。每栏的第三个方框都被标出，因为那是两者唯一不同的一步。",
  "Verified structures and routes": "已验证的结构与路线",
  "WEIGHT-FREE AI · INDUSTRIAL DECISION ASSURANCE": "无权重人工智能 · 工业决策保障",
  "WHAT AN EPISODE MAY LEAVE BEHIND": "一次回合可能留下什么",
  "What each kind of system keeps between data and answer": "两类系统在数据与答案之间各自保留了什么",
  "What kind of system this is": "这是哪一类系统",
  "What was checked, what ran, what was refused, and what it cost.": "检查了什么、跑了什么、拒了什么，以及花了多少。",
  "Which candidate to try first. An ordering of a declared list, not a score attached to it.":
    "先试哪个候选。这是对一份已声明清单的排序，而不是附在上面的分数。",
  "Written-out routes": "写出来的路线",
  "marked: the one step where the two differ": "标记：两者唯一不同的一步",
};
...
export const weightFreeAr: TranslationDictionary = {
  ...
  "A probabilistic answer": "جوابٌ احتماليّ",
  "A procedure recorded as steps rather than as behaviour, versioned, and replayable as it stood.":
    "إجراءٌ مسجَّلٌ خطواتٍ لا سلوكًا، له إصداره، ويُعاد تشغيله كما كان.",
  "A reproducible answer": "جوابٌ قابل لإعادة الإنتاج",
  "A structure that passed its formation checks, standing as active, weakened, or retired.":
    "بنيةٌ اجتازت فحوص تكوُّنها، قائمةٌ بوصفها فعّالة أو مُضعَفة أو مُتقاعِدة.",
  "A system is shown a great many examples, and while it looks at them it quietly adjusts millions of internal numbers until the answers come out about right. Those numbers are what it learned. None of them means anything on its own, so when you ask why, the honest reply is often that this is how it came out inside.":
  ...
  "An AI architecture with no learned model weights and no backpropagation. GALO learns explicit relations and verified structures in a versioned Atlas, starting with industrial decision assurance. Scoped learning results are published together with their negatives; partner-controlled validity is not proven and production autonomy is not authorised.":
    "بنيةُ ذكاءٍ اصطناعيّ بلا أوزانٍ متعلَّمة وبلا انتشارٍ عكسيّ. يتعلَّم GALO علاقاتٍ صريحة وبنًى مُثبَتة داخل Atlas ذي إصدارات، بدءًا من ضمان القرار الصناعي. وتُنشَر نتائج التعلُّم المحدودة النطاق مع نتائجها السلبية؛ والصلاحية التي يتحكّم بها الشريك غير مُثبَتة، والاستقلالية الإنتاجية غير مأذون بها.",
  ...
  "Both paths begin with data and end with an answer. They differ in one place: what the system keeps in between. A weight is a number that came out of training and carries no name; a structure is something that was named, checked, and written down before it was kept.":
    "يبدأ المساران من البيانات وينتهيان بجواب، ويفترقان في موضعٍ واحد: ما الذي يحتفظ به النظام بينهما. فالوزن رقمٌ خرج من التدريب ولا اسم له؛ أمّا البنية فشيءٌ سُمِّي وفُحص وكُتب قبل أن يُحتفَظ به.",
  "By building, checking, reusing and locally revising explicit structures. There is no parameter tensor to adjust, no gradient step and no backpropagation anywhere in the engine.":
  ...
  "Counters": "العدّادات",
  "Data": "البيانات",
  "Data and experience": "البيانات والخبرة",
  "Discrete orders": "ترتيبات منفصلة",
  "Everything further down this page — the percentages, the receipts, the seven phases, the tables — is evidence about a kind of object. This section says what the object is, because the evidence does not mean much until that is clear.":
  ...
  "How often something has held up, kept as a whole number anybody can read and compare.":
    "كم مرّةً صمد شيءٌ ما، محفوظًا عددًا صحيحًا يستطيع أيُّ أحدٍ قراءته ومقارنته.",
  "If learning is not weights, here is the whole of what it is instead.":
    "إن لم يكن التعلُّم أوزانًا، فهذا هو كلُّ ما هو عليه بدلًا منها.",
  ...
  "Know what changed, what it affects, and why the decision still stands.":
    "أن تعرف ما الذي تغيَّر، وما الذي يمسُّه، ولماذا يظلّ القرار قائمًا.",
  "Local learning, and local revision.": "تعلُّمٌ موضعيّ، ومراجعةٌ موضعية.",
  "Millions of numbers, none of them named": "ملايينُ الأرقام، وليس لواحدٍ منها اسم",
  ...
  "Neural AI learns by changing hidden numerical weights. GALO has no learned weights and uses no backpropagation. It learns by building, checking, reusing and locally revising explicit objects, relations, competing explanations and evidence in a versioned Atlas, so every learned change can be read, versioned and replayed. The first product applies that architecture to decision assurance around the digital twins and operational systems a plant already runs.":
    "يتعلَّم الذكاءُ الاصطناعي العصبيّ بتغيير أوزانٍ عددية خفيّة. أمّا GALO فلا أوزان متعلَّمة لديه ولا يستعمل الانتشار العكسيّ. إنّه يتعلَّم ببناء أشياء وعلاقاتٍ وتفسيراتٍ متنافسة وأدلّةٍ صريحة داخل Atlas ذي إصدارات، وبفحصها وإعادة استعمالها ومراجعتها موضعيًّا، فيصير كلُّ تغيُّرٍ متعلَّم قابلًا للقراءة والتأريخ وإعادة التشغيل. ويُطبِّق المنتج الأوّل هذه البنية على ضمان القرار حول التوائم الرقمية والأنظمة التشغيلية التي يشغّلها المصنع أصلًا.",
  "Neural AI learns weights. GALO learns structures.":
    "الذكاء الاصطناعي العصبيّ يتعلَّم أوزانًا. وGALO يتعلَّم بنًى.",
  "No learned weights and no backpropagation: what the engine learns is explicit and can be read, versioned and rolled back. The first product applies that to decision assurance around the systems a plant already runs. This page is the investment case: why this could be a company, what a cheque buys, what would unlock the next round, and the point at which the thesis should be called dead.":
    "لا أوزان متعلَّمة ولا انتشار عكسيّ: فما يتعلَّمه المحرّك صريحٌ يمكن قراءته وتأريخه بإصدارات والتراجع عنه. ويُطبِّق المنتج الأوّل ذلك على ضمان القرار حول الأنظمة التي يشغّلها المصنع أصلًا. وهذه الصفحة هي حجّة الاستثمار: لماذا قد يصير هذا شركة، وما الذي يشتريه الشيك، وما الذي يفتح الجولة التالية، وعند أيّ نقطةٍ تُعدّ الأطروحة ميتة.",
  ...
  "Ordinary AI learns by changing hidden weights. This one has none to change.":
    "الذكاء الاصطناعي المعتاد يتعلَّم بتغيير أوزانٍ خفيّة. وهذا لا أوزان لديه ليغيّرها.",
  "Ordinary AI learns by changing millions of hidden numbers. This one learns by changing things that are written down.":
  ...
  "Six kinds of thing, and the list is complete rather than illustrative. Each one can be printed, compared with the same item from an earlier run, and rolled back on its own without touching the rest.":
    "ستّة أنواع، والقائمة كاملةٌ لا على سبيل المثال. ويمكن طباعةُ كلٍّ منها ومقارنتُه بالبند نفسه من تشغيلٍ سابق، والتراجعُ عنه وحده دون المساس بالبقيّة.",
  "Static scan of the active import closure, run by the project":
    "مسحٌ ساكن لمُغلَق الاستيراد الفعّال، أجراه المشروع بنفسه",
  "THE DIFFERENCE, BEFORE ANY NUMBERS": "الفرق، قبل أيّ أرقام",
  "TWO KINDS OF LEARNING": "نوعان من التعلُّم",
  "The architecture is meant to be general, and it is weight-free: nothing it learns is a hidden number, so an affected decision can be named rather than inferred. The first product is deliberately narrow — one industrial workflow, read only, advisory, with a frozen baseline and a decision package somebody else can replay. Industry is where the cost of ambiguity is already counted, which is why an architecture is worth testing there first.":
  ...
  "Two columns of four boxes joined downward by arrows. The neural column runs from data to training to hidden numerical weights to a probabilistic answer. The GALO column runs from data and experience to explicit objects and relations to verified structures and routes to a reproducible answer. The third box in each column is marked, because that is the only step where the two differ.":
    "عمودان في كلٍّ منهما أربعة مربّعات موصولةٌ نزولًا بأسهم. يمضي عمودُ الذكاء الاصطناعي العصبيّ من البيانات إلى التدريب، ثمّ إلى أوزانٍ عددية خفيّة، ثمّ إلى جوابٍ احتماليّ. ويمضي عمودُ GALO من البيانات والخبرة إلى أشياء وعلاقات صريحة، ثمّ إلى بنًى ومسارات مُثبَتة، ثمّ إلى جوابٍ قابل لإعادة الإنتاج. والمربّع الثالث في كلا العمودين معلَّم، لأنّه الخطوة الوحيدة التي يفترقان فيها.",
  "Verified structures and routes": "بنًى ومسارات مُثبَتة",
  "WEIGHT-FREE AI · INDUSTRIAL DECISION ASSURANCE": "ذكاءٌ اصطناعيّ بلا أوزان · ضمان القرار الصناعي",
  "WHAT AN EPISODE MAY LEAVE BEHIND": "ما الذي قد تتركه الحلقة وراءها",
  "What each kind of system keeps between data and answer":
    "ما الذي يحتفظ به كلُّ نوعٍ من الأنظمة بين البيانات والجواب",
  ...
  "Which candidate to try first. An ordering of a declared list, not a score attached to it.":
    "أيُّ المرشّحين يُجرَّب أوّلًا. ترتيبٌ على قائمةٍ معلَنة، لا درجةٌ تُلحَق بها.",
  "Written-out routes": "مسارات مكتوبة",
  "marked: the one step where the two differ": "معلَّم: الخطوة الوحيدة التي يفترقان فيها",
};
