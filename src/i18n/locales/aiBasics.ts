...
export const aiBasicsRu: TranslationDictionary = {
  ...
  "Start here if AI is not your field":
    "Начните отсюда, если ИИ — не ваша область",
  ...
  "Deterministic":
    "Детерминированность",
  "Every 'receipt' on this site is one of these.":
    "Каждая «квитанция» на этом сайте — как раз он.",
  ...
  "Hallucination":
    "Галлюцинация",
  "If you do not work with AI at all":
    "Если вы вообще не про ИИ",
  "Inference":
    "Инференс",
  "It is already in use somewhere.":
    "Наверняка это уже где-то работает.",
  "It is smarter, or safer, or faster.":
    "Значит, оно умнее, безопаснее или быстрее.",
  ...
  "It must be trying to replace ChatGPT.":
    "Значит, вы пытаетесь заменить ChatGPT.",
  ...
  "So it is another chatbot.":
    "Значит, это очередной чат-бот.",
  ...
  "THE AI WORDS EVERYONE USES":
    "СЛОВА ИЗ МИРА ИИ, КОТОРЫМИ ПОЛЬЗУЮТСЯ ВСЕ",
  "THE SAME THREE STEPS, TWO DIFFERENT WAYS":
    "ТЕ ЖЕ ТРИ ШАГА, ДВУМЯ РАЗНЫМИ СПОСОБАМИ",
  "The AI words everyone uses":
    "Слова из мира ИИ, которыми пользуются все",
  ...
  "This is the property the whole project is organised around.":
    "Вокруг этого свойства и построен весь проект.",
  "Training":
    "Обучение",
  "Twelve words from the AI world, each in one sentence.":
    "Двенадцать слов из мира ИИ, каждое — в одном предложении.",
  ...
  "Where the answer comes from, and what is left over afterwards.":
    "Откуда берётся ответ и что остаётся после него.",
  "Why it turns up here":
    "Почему это слово тут",
...
export const aiBasicsAr: TranslationDictionary = {
  ...
  "Start here if AI is not your field":
    "ابدأ من هنا إن لم يكن الذكاء الاصطناعي مجالك",
  "A model trained on an enormous amount of text, which produces the next word over and over until a reply appears. ChatGPT and its relatives are these.":
  ...
  "Deterministic":
    "الحتمية",
  "Every 'receipt' on this site is one of these.":
    "كل «إيصال» في هذا الموقع هو هذا بعينه.",
  "GALO does no training at all today. That is unusual enough that people assume it is a mistake.":
  ...
  "Hallucination":
    "الهلوسة",
  "If you do not work with AI at all":
    "إن لم يكن الذكاء الاصطناعي مجالك أصلاً",
  "Inference":
    "الاستدلال",
  "It is already in use somewhere.":
    "لا شكّ أنّه يعمل في مكان ما.",
  "It is smarter, or safer, or faster.":
    "إذن فهو أذكى أو أأمن أو أسرع.",
  "It is the ordinary state of affairs in AI, and the thing we are trying not to build.":
  ...
  "It must be trying to replace ChatGPT.":
    "إذن فأنتم تحاولون أن تحلّوا محلّ ChatGPT.",
  "Large language model":
    "نموذج لغوي كبير",
  "Model":
    "نموذج",
  ...
  "So it is another chatbot.":
    "إذن فهذا مجرّد روبوت محادثة آخر.",
  "Somebody who does not trust you can run the same thing themselves and get the same result, without asking you for anything.":
  ...
  "THE AI WORDS EVERYONE USES":
    "كلمات الذكاء الاصطناعي التي يستعملها الجميع",
  "THE SAME THREE STEPS, TWO DIFFERENT WAYS":
    "الخطوات الثلاث نفسها بطريقتين مختلفتين",
  "The AI words everyone uses":
    "كلمات الذكاء الاصطناعي التي يستعملها الجميع",
  "The instructions a program is built from are published, so anyone can read them and run them.":
  ...
  "This is the property the whole project is organised around.":
    "حول هذه الخاصية بُني المشروع كلّه.",
  "Training":
    "التدريب",
  "Twelve words from the AI world, each in one sentence.":
  ...
  "Where the answer comes from, and what is left over afterwards.":
    "من أين يأتي الجواب وماذا يبقى بعده.",
  "Why it turns up here":
    "لماذا ترد هنا",
  "You do not need to know anything about artificial intelligence to read this page.":
