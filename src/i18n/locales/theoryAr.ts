...
export const theoryAr: TranslationDictionary = {
  ...
  "GALO Theory for Beginners — From States to Verified Execution":
    "نظرية GALO للمبتدئين — من الحالات إلى التنفيذ المتحقَّق منه",
  ...
  "Guided transition laboratory": "مختبر الانتقال الموجَّه",
  ...
  "This guided chapter starts with a three-state dial and builds the theory one verified step at a time. Every key idea is shown in plain language, as a formula, as a finite table, and with an explicit limit on what it proves.":
    "يبدأ هذا الفصل الموجَّه بقرص ذي ثلاث حالات، ثم يبني النظرية خطوةً خطوة، وكلُّ خطوة متحقَّق منها. وتُعرض كل فكرة أساسية بلغة مبسطة، وبصيغة، وبجدول منتهٍ، مع حدّ صريح لما تثبته.",
  ...
  "The formal kernel is an exact alphabet for state transitions. It is not by itself a language model, a trained memory, a proof of intelligence, or a certificate that a statement about the world is true.":
    "النواة الشكلية أبجدية دقيقة لانتقالات الحالة. وهي ليست في ذاتها نموذجًا لغويًا، ولا ذاكرة مدرَّبة، ولا برهانًا على الذكاء، ولا شهادةً بأن عبارةً عن العالم صحيحة.",
  ...
  "L_n uses n labelled poles. For calculation, P_i corresponds to the remainder i modulo n. This correspondence supplies exact arithmetic without claiming that a pole has one universal meaning.":
    "يتكوّن L_n من n أقطاب مسمّاة. ولأغراض الحساب يقابل P_i فئة الباقي i بالمقياس n. يوفّر هذا التقابل حسابًا دقيقًا من دون الادعاء بأن للقطب معنى عالميًا واحدًا.",
  "The L3 dial": "قرص L3",
  ...
  "The dial explains modular arithmetic, not the semantics of GALO. P0 is not automatically false, empty, bad, safe, or authorized; P1 and P2 are not quantities unless a separate model declares them to be.":
    "يشرح القرص الحساب بالمقياس عدد صحيح، لا دلالات GALO. لا يعني P0 تلقائيًا الخطأ أو الفراغ أو السوء أو الأمان أو التفويض، ولا يمثل P1 وP2 كميتين ما لم يصرّح نموذج منفصل بذلك.",
  ...
  "Source means the state being transformed. Active means the pole applied to it. LEFT puts source on the raw left; RIGHT puts active there instead. These names describe interface roles and borrow nothing from the standard vocabulary of algebraic translations.":
    "تعني حالة المصدر الحالة التي يجري تحويلها، ويعني القطب النشط القطب المطبَّق عليها. يضع LEFT حالة المصدر في موضع المُعامل الأيسر الخام، ويضع RIGHT القطب النشط في ذلك الموضع. يصف الاسمان دوري الواجهة، لا المصطلحين القياسيين للترجمات الجبرية.",
  ...
  "PLUS always adds the two indices and wraps around modulo {level}.":
    "يجمع PLUS الفهرسين دائمًا ثم يطبّق الالتفاف بالمقياس {level}.",
  ...
  "STAR sees a nonzero raw-left pole, so this cell follows cyclic addition modulo {level}.":
    "يرى STAR قطبًا غير صفري في موضع المُعامل الأيسر الخام، ولذلك تتبع هذه الخلية الجمع الدوري بالمقياس {level}.",
  ...
  "The complete typed address is {cellId}. The target is stored as its own result and never hidden inside the ID.":
    "العنوان الكامل المحدد النوع هو {cellId}. ويُخزَّن الهدف بوصفه نتيجة، ولا يُخفى داخل المعرّف.",
  ...
  "Count addresses first, laws second, and semantic role placements third.":
    "عُدَّ العناوين أولًا، ثم القوانين، ثم مواضع الأدوار الدلالية.",
  ...
  "560 learned skills": "560 مهارة متعلَّمة",
  ...
  "Because a typed coordinate records semantic roles, not only its numeric output. Two transitions may end at the same pole while carrying different source-active provenance and different compatibility obligations.":
    "لأن الإحداثي المحدد النوع يسجل الأدوار الدلالية، لا ناتجه العددي وحده. وقد ينتهي انتقالان عند القطب نفسه مع اختلاف كلٍّ منهما في منشأ توزيع دورَي حالة المصدر والقطب النشط، وفي التزامات التوافق.",
  ...
  "Orbit membership does not make two records semantically identical and does not merge their provenance, permissions, evidence, or real-world consequences.":
    "لا تجعل العضوية في المدار سجلين متطابقين دلاليًا، ولا تدمج سجلَّي منشئهما أو صلاحياتهما أو أدلتهما أو آثارهما في العالم الواقعي.",
  ...
  "A deterministic selector orders a finite declared candidate frontier for exactly two fixed source patterns.":
    "يرتب محدِّد حتمي جبهة مرشحين منتهية ومعلنة لنمطي مصدر ثابتين بالضبط.",
  ...
  "Membership, one-shot execution, rollback, revocation, and work accounting are recorded within the current scope.":
    "تُسجَّل العضوية والتنفيذ أحادي الاستخدام والتراجع والإبطال ومحاسبة العمل ضمن النطاق الحالي.",
  ...
  "run a persistent learned policy": "يشغّل سياسة متعلَّمة مستديمة",
  "contain a trained World Atlas": "يحتوي World Atlas مدرَّبًا",
  ...
  "Fresh FULL was not run and CPython 3.13 was unavailable in the review session.":
    "لم يُنفَّذ مسار FULL تنفيذًا حديثًا، ولم يكن CPython 3.13 متاحًا في جلسة المراجعة.",
  ...
  "P_i is identified with residue i modulo n for calculation.": "يُعرَّف P_i حسابيًا بفئة الباقي i بالمقياس n.",
  Level: "المستوى",
  ...
  "L_n uses the n-element carrier Q_n; a larger n is not automatically better or more intelligent.":
    "يستخدم L_n الحامل Q_n المكوَّن من n عناصر؛ ولا تكون القيمة الأكبر لـn أفضل أو أكثر ذكاءً تلقائيًا.",
  ...
  "The second semantic input applied to the source.": "المُدخل الدلالي الثاني المطبَّق على حالة المصدر.",
  ...
  "It need not be injective; the zero homomorphism exists for every ordered level pair.":
    "لا يلزم أن يكون متباينًا؛ فالتشاكل الصفري موجود لكل زوج مرتب من المستويات.",
  ...
  "An injective homomorphism; nonzero A_n→A_m embeddings for n≥2 exist exactly when n divides m.":
    "تشاكل متباين؛ توجد تضمينات غير صفرية A_n→A_m عند n≥2 بالضبط عندما تقسم n العدد m.",
  Receipt: "إيصال تنفيذ",
  ...
  "They are formal transition addresses. Semantics, memory, and learned parameters are separate object classes.":
    "إنها عناوين انتقال شكلية. أما الدلالات والذاكرة والمعاملات المتعلَّمة فهي فئات كائنات منفصلة.",
  ...
  "The zero homomorphism exists. What does not exist is a nonzero or injective full-algebra embedding.":
    "التشاكل الصفري موجود. وما لا يوجد هو تضمين غير صفري أو متباين للجبر الكامل.",
  "Verified finite mathematics proves learning or General AI.":
    "تثبت الرياضيات المنتهية المتحقَّق منها التعلّم أو الذكاء الاصطناعي العام.",
  ...
  "End of beginner contour: finite mathematics is established and independently tested; persistent learning, a trained current Atlas, external operational gain, and General AI are not established.":
    "نهاية مسار المبتدئين: الرياضيات المنتهية مثبتة ومختبَرة على نحو مستقل؛ أما التعلّم المستديم وAtlas الحالي المدرَّب والمكسب التشغيلي الخارجي والذكاء الاصطناعي العام فغير مثبتة.",
  ...
  "A local pole is not the agent's complete world state. The target architecture may use typed coordinates as components of an explicit World Atlas, but the formal kernel alone is not a language model, trained memory, proof of intelligence, or truth certificate.":
    "القطب المحلي ليس حالة العالم الكاملة للوكيل. قد تستخدم البنية المستهدفة إحداثيات محددة النوع بوصفها مكوّنات في World Atlas صريح، لكن النواة الشكلية وحدها ليست نموذجًا لغويًا، ولا ذاكرة مدرَّبة، ولا برهانًا على الذكاء، ولا شهادة حقيقة.",
  ...
  "A descriptor may be non-executable and is not a learned concept or completed action.":
    "قد تكون الواصفة غير قابلة للتنفيذ، وهي ليست مفهومًا متعلَّمًا ولا فعلًا مكتملًا.",
  "The parity-filtered candidates that the deterministic selector is allowed to order.":
    "المرشحون المرشَّحون وفق الزوجية أو الفردية الذين يجوز للمحدِّد الحتمي ترتيبهم.",
  "The order comes out of a hash. No semantic judgment, probability, or learned preference goes into it.":
    "يُشتق الترتيب من قيمة التجزئة، وليس حكمًا دلاليًا ولا احتمالًا ولا تفضيلًا متعلَّمًا.",
  ...
  "Current rollback, revocation, and sequencing are process-local; no persistent trusted head is implemented.":
    "التراجع والإبطال والتسلسل الحالي عمليات محلية ضمن العملية الحاسوبية؛ ولم يُنفَّذ رأس موثوق مستديم.",
  ...
  "A trained current Atlas is not present and Atlas state has no effect on current V4 ranking.":
    "لا يوجد Atlas حالي مدرَّب، ولا تؤثر حالة Atlas في ترتيب V4 الحالي.",
  ...
  sigma: "سيغما",
  "units modulo n": "الوحدات بالمقياس n",
  "orbit of x": "مدار x",
  "stabilizer of x": "مثبّت x",
  "fixed points of g": "النقاط الثابتة لـ g",
  "X modulo the action of G": "X بالمقياس فعل G",
  "The complete n-element carrier at level L_n.": "الحامل الكامل المكوَّن من n عناصر عند المستوى L_n.",
  "The pole whose calculation index is i modulo n.": "القطب الذي فهرس حسابه i بالمقياس n.",
  ...
  "Indices u with gcd(u,n)=1; multiplication by u gives the allowed pointed relabellings.":
    "الفهارس u التي تحقق gcd(u,n)=1؛ ويعطي الضرب في u عمليات إعادة التسمية المدبَّبة المسموح بها.",
  ...
  "Source is the local pole from which this typed transition begins. Active is the pole applied to that source. LEFT puts source on the raw left; RIGHT puts active on the raw left. These names describe interface roles, not a complete World Atlas state and not standard algebraic translation terminology.":
    "حالة المصدر هي القطب المحلي الذي يبدأ منه هذا الانتقال المحدد النوع، والقطب النشط هو القطب المطبَّق على حالة المصدر. يضع LEFT حالة المصدر في موضع المُعامل الأيسر الخام، ويضع RIGHT القطب النشط في ذلك الموضع. تصف هذه الأسماء أدوار الواجهة، لا حالة World Atlas كاملة، ولا مصطلحات الترجمة الجبرية القياسية.",
  ...
  "STAR is a pointed total magma with a left zero and right-neutral P0. At n≥2 it is noncommutative, nonassociative, and has no affine translation symmetry layer.":
    "STAR ماغما كلية مدبَّبة لها صفر أيسر وP0 محايد من اليمين. وعند n≥2 تكون غير تبديلية وغير تجميعية، ولا تملك طبقة تناظر للترجمات التآلفية.",
  ...
  "The shift moves the distinguished reset point P0. It is valid for the unpointed PLUS torsor but fails the STAR law.":
    "تنقل الإزاحة نقطة إعادة الضبط المميَّزة P0. وهي صحيحة للفضاء المتجانس الرئيسي غير المدبَّب لـ PLUS، لكنها لا تحفظ قانون STAR.",
  ...
  "The example above acts on three individual poles at L3. The whole-tower count acts on ordered source-active pairs, separately inside every level and every one of the four family fibres.":
    "يؤثر المثال أعلاه في 3 أقطاب منفردة عند L3. أما عدّ البرج كله فيؤثر في أزواج مرتبة من حالة المصدر والقطب النشط، كلٌّ على حدة داخل كل مستوى وكل واحدة من ليفات العائلات الأربع.",
  ...
  "PLUS preservation makes the image of the generator determine the entire map.":
    "يجعل حفظ PLUS صورةَ المولِّد تحدد التطبيق كله.",
  "If the map is injective, the image of P1 must retain its exact cyclic order n.":
    "إذا كان التطبيق متباينًا، وجب أن تحتفظ صورة P1 برتبتها الدورية الدقيقة n.",
  ...
  "Conversely, when n divides m, scaled maps h(P_i)=P_((u·m/n)i mod m) for unit u modulo n provide the nonzero embeddings; the archived replay selects one canonical scaling.":
    "وبالعكس، عندما تقسم n العدد m، تعطي التطبيقات المحجَّمة h(P_i)=P_((u·m/n)i mod m)، حيث u وحدة بالمقياس n، التضمينات غير الصفرية؛ وتختار إعادة التشغيل المؤرشفة تحجيمًا معياريًا واحدًا.",
  ...
  "Only two exact closed patterns are accepted; arbitrary free text is outside this selector contract.":
    "لا يُقبل إلا نمطان مغلقان ودقيقان؛ ويقع النص الحر الاعتباطي خارج عقد هذا المحدِّد.",
  ...
  "The recognized source pattern selects one half of the executable enumeration.":
    "يختار نمط المصدر المتعرَّف إليه نصف التعداد القابل للتنفيذ.",
  ...
  "Membership, one-shot execution, process-local rollback, process-local revocation, and work accounting are recorded within the current scope.":
    "تُسجَّل العضوية والتنفيذ أحادي الاستخدام والتراجع المحلي ضمن العملية والإبطال المحلي ضمن العملية ومحاسبة العمل داخل النطاق الحالي.",
  ...
  "Every stage below is architectural intent. It must not be read as a current runtime capability, trained system, external result, or authorized learning claim.":
    "كل مرحلة أدناه مقصد معماري. ويجب ألا تُفهم بوصفها قدرة حالية في وقت التشغيل، أو نظامًا مدرَّبًا، أو نتيجة خارجية، أو ادعاءً مفوَّضًا بالتعلّم.",
  "Accept externally grounded evidence with source custody, and stop relying on a bundled finite sample alone.":
    "اقبل دليلًا مستندًا إلى مرجع خارجي مع حفظ عهدة المصدر، لا مجرد عينة منتهية مضمَّنة.",
  ...
  "Build GALO from one three-state example before opening the academic reference.":
    "كوِّن فهمك لـ GALO انطلاقًا من مثال واحد ذي ثلاث حالات قبل فتح المرجع الأكاديمي.",
  ...
  "Open the guided theory": "افتح فصل النظرية الموجَّه",
  "Name the finite states": "سمِّ الحالات المنتهية",
  ...
  "A formal target is not yet world meaning, a useful action, a learned policy, or General AI.":
    "لا يمثل الهدف الشكلي بعدُ دلالةً في العالم، ولا فعلًا مفيدًا، ولا سياسةً متعلَّمة، ولا ذكاءً اصطناعيًا عامًا.",
  "ILLUSTRATIVE TARGET RESOLUTION LADDER": "سُلَّم توضيحي لدقة التمييز المستهدفة",
  "Illustrative target resolution ladder": "سُلَّم توضيحي لدقة التمييز المستهدفة",
  ...
  "The level is declared by listing one label for each residue from 0 through n−1, so no extra pole is hidden outside the list.":
    "يُعرَّف المستوى بسرد تسمية واحدة لكل فئة باقية من 0 حتى n−1، لذلك لا يوجد قطب إضافي مخفي خارج القائمة.",
  ...
  "P_i∈Q_n with 0≤i<n; calculation identifies P_i with residue i modulo n.":
    "P_i∈Q_n مع 0≤i<n؛ وفي الحساب يمثّل P_i فئة الباقي i بالمقياس n.",
  ...
  "Changing level is like choosing a dial with a different number of marked positions.":
    "تغيير المستوى يشبه اختيار قرص له عدد مختلف من المواضع المعلَّمة.",
  "L_n is the local frame whose carrier is Q_n and whose index arithmetic is modulo n.":
    "L_n هو الإطار المحلي الذي حامله Q_n وحساب فهارسه بالمقياس n.",
  ...
  "Modulo arithmetic is clock arithmetic: after the last mark, counting continues from the first mark.":
    "الحساب بالمقياس n يشبه حساب الساعة: بعد آخر علامة نتابع العد من العلامة الأولى.",
  ...
  "It is the multiplication-table idea applied to any finite two-input rule.":
    "إنه فكرة جدول الضرب مطبَّقة على أي قاعدة منتهية ذات مُدخلين.",
  ...
  "Count an inventory by addresses: input squares first, rule books second, and role labels third.":
    "عُدَّ المخزون بالعناوين: مربعات المُدخلات أولًا، ثم كتابَي القوانين، ثم تسميات الأدوار.",
  ...
  "The 560 records are not neurons, concepts, learned skills, meanings, or units of intelligence.":
    "السجلات الـ560 ليست عصبونات أو مفاهيم أو مهارات متعلَّمة أو معاني أو وحدات ذكاء.",
  ...
  "This is finite transformation rank, not learned matrix rank; ABI LEFT is the standard right translation when active is fixed.":
    "هذه رتبة تحويل منتهٍ، لا رتبة مصفوفة متعلَّمة؛ وعند تثبيت القطب النشط تكون ABI LEFT هي الترجمة اليمنى القياسية.",
  ...
  "A left-associated STAR word follows modular prefix sums until a prefix equals P0; after that point every later value is P0.":
    "تتبع كلمة STAR المجمّعة من اليسار مجاميع البوادئ بالمقياس n إلى أن تساوي بادئة ما P0؛ وبعد ذلك تكون كل قيمة لاحقة P0.",
  ...
  "A congruence allows labels to be merged only when every operation remains well-defined after the merge.":
    "تسمح علاقة التطابق بدمج التسميات فقط عندما تبقى كل عملية معرَّفة تعريفًا سليمًا بعد الدمج.",
  ...
  "A unit u is invertible modulo n, so multiplication by u is a permutation and distributes over modular addition without moving zero.":
    "للوحدة u معكوس بالمقياس n، لذلك فالضرب في u تبديل، ويتوزع على الجمع بالمقياس n من دون تحريك الصفر.",
  ...
  "Count symmetry classes by averaging how many objects each symmetry button leaves unmoved.":
    "عُدَّ فئات التناظر بأخذ متوسط عدد الكائنات التي يتركها كل زر تناظر ثابتة.",
  ...
  "A marked dial can be relabelled around its fixed origin; an unmarked dial may also be rotated before relabelling.":
    "يمكن إعادة تسمية قرص ذي أصل معلَّم حول أصله الثابت؛ أما القرص غير المعلَّم فيمكن أيضًا تدويره قبل إعادة التسمية.",
  ...
  "L3 shift T1(x)=x+1 preserves the unpointed affine torsor, but T1(P0★P0)=P1 while T1(P0)★T1(P0)=P2.":
    "إزاحة L3 المسماة T1(x)=x+1 تحفظ الفضاء المتجانس الرئيسي الأفيني غير المعيَّن، لكن T1(P0★P0)=P1 بينما T1(P0)★T1(P0)=P2.",
  ...
  "The residue 3 is zero modulo 3 but not globally zero modulo 6, so a coordinatewise reset fires when the original STAR reset does not.":
    "فئة الباقي 3 صفر بالمقياس 3، لكنها ليست صفرًا كليًا بالمقياس 6؛ لذلك تنطلق إعادة ضبط مركّبية حين لا تنطلق إعادة ضبط STAR الأصلية.",
  ...
  "L6 STAR: row P3, column P1 → P4; coordinate STAR resets the modulo-3 component.":
    "في STAR عند L6: الصف P3 والعمود P1 → P4؛ أما STAR المركّبية فتعيد ضبط المركّبة بالمقياس 3.",
  ...
  "A character labels dial positions by equally spaced arrows on the complex unit circle while respecting addition.":
    "يسمّي الطابع مواضع القرص بسهام متساوية التباعد على دائرة الوحدة العقدية مع احترام الجمع.",
  "A character is a group homomorphism C_n→C×; χ_s(k)=exp(2πisk/n), so χ_s(k+ℓ)=χ_s(k)χ_s(ℓ). It is faithful exactly when gcd(s,n)=1.":
    "الطابع تشاكل زمري C_n→C×؛ وتُعطى χ_s(k)=exp(2πisk/n)، ولذلك χ_s(k+ℓ)=χ_s(k)χ_s(ℓ). ويكون الطابع أمينًا بالضبط عندما gcd(s,n)=1.",
  ...
  "Count objects inside labelled drawers first; adding drawer totals does not create one giant drawer.":
    "عُدَّ الكائنات داخل الأدراج المسمّاة أولًا؛ جمع مجاميع الأدراج لا يصنع درجًا عملاقًا واحدًا.",
  ...
  "Matching pole names or being injective as a set map does not prove operation preservation.":
    "لا يثبت تطابق أسماء الأقطاب أو تباين التطبيق بين المجموعات أنه يحفظ العمليات.",
  ...
  "An embedding places the smaller dial inside the larger one without merging any of its marked positions.":
    "يضع التضمين القرص الأصغر داخل الأكبر من دون دمج أي موضع من مواضعه المعلَّمة.",
  "An embedding is an injective homomorphism; for n≥2, A_n embeds in A_m exactly when n divides m.":
    "التضمين تشاكل متباين؛ وعندما n≥2 يمكن تضمين A_n في A_m بالضبط عندما تقسم n العدد m.",
  ...
  "∈ means belongs to; ⇒ implies; ⇔ if and only if; ∅ empty set; ∤ does not divide; ⊆ subset; Δ equality relation; ord order; Aut automorphisms; End endomorphisms; Hom homomorphisms; φ Euler totient or a named map by context; gcd greatest common divisor; binom binomial coefficient; ⋊ semidirect product; χ character; exp exponential.":
    "تعني ∈ «ينتمي إلى»؛ وتعني ⇒ «يستلزم»؛ وتعني ⇔ «إذا وفقط إذا»؛ و∅ المجموعة الخالية؛ و∤ لا يقسم؛ و⊆ مجموعة جزئية؛ وΔ علاقة المساواة؛ وord الرتبة؛ وAut التشاكلات الذاتية؛ وEnd التشاكلات الداخلية؛ وHom التشاكلات؛ وتدل φ بحسب السياق على دالة أويلر أو على تطبيق مسمّى؛ وgcd القاسم المشترك الأكبر؛ وbinom معامل ثنائي الحدين؛ و⋊ جداء شبه مباشر؛ وχ طابع؛ وexp التطبيق الأسي.",
  ...
  "The tuple (2,2,0) lists arities. Level sizes, tensor dimensions, and learned layer widths are all something else.":
    "تسرد الثلاثية (2,2,0) أريات العمليات، لا أحجام المستويات ولا أبعاد الموترات ولا عروض الطبقات المتعلَّمة.",
  ...
  "Modulo n always returns an index 0,…,n−1, and the reset branch returns P0, which is already in Q_n.":
    "يعيد الحساب بالمقياس n دائمًا فهرسًا من 0,…,n−1، ويعيد فرع إعادة الضبط P0 الموجود أصلًا في Q_n.",
  ...
  "The inverse index cancels i modulo n, and a step k visits n/gcd(k,n) distinct residues.":
    "يلغي فهرس المعكوس i بالمقياس n، وتزور الخطوة k عدد n/gcd(k,n) من فئات البواقي المختلفة.",
  ...
  "Function, injection, surjection, and bijection": "الدالة والتباين والغَمر والتقابل",
  "A function gives every student one locker; injective forbids sharing, surjective leaves no locker unused, and bijective does both.":
    "تعطي الدالة كل طالب خزانة واحدة؛ ويمنع التباين المشاركة، ولا يترك الغَمر خزانة بلا مستخدم، ويجمع التقابل الشرطين.",
  "function: one output per input; injective: f(x)=f(y)⇒x=y; surjective: Im(f)=Y; bijective: injective and surjective.":
    "function: مخرج واحد لكل مُدخل؛ injective: ‏f(x)=f(y)⇒x=y؛ surjective: ‏Im(f)=Y؛ bijective: تباين وغَمر معًا.",
  "L2→L4 map P0→P0,P1→P2 is injective but not surjective; L3 multiplication by 2 is bijective.":
    "التطبيق L2→L4 المعرّف بـP0→P0 وP1→P2 متباين لكنّه غير غامر؛ والضرب في 2 تقابلي في L3.",
  "The definitions test collisions and coverage separately; on equal finite sets, injective and surjective are equivalent.":
    "تفحص التعريفات التصادمات والتغطية كلًا على حدة؛ وعلى مجموعتين منتهيتين متساويتي الحجم يتكافأ التباين والغَمر.",
  "A homomorphism need not be injective, and an injection is not an embedding until operation preservation is proved.":
    "لا يلزم أن يكون التشاكل متباينًا، وليست الدالة المتباينة تضمينًا حتى يثبت حفظ العمليات.",
  ...
  "A residue has a multiplicative inverse modulo n exactly when it is coprime to n.":
    "لفئة باقٍ معكوس ضربي بالمقياس n بالضبط عندما تكون أولية نسبيًا مع n.",
  ...
  "[x]★[y]=[x★y] is well-defined only when ∼ is a congruence.":
    "[x]★[y]=[x★y] معرَّفة تعريفًا سليمًا فقط عندما تكون ∼ علاقة تطابق.",
  ...
  "Every nonzero full-algebra endomorphism at n≥2 is injective and hence bijective on the finite carrier; the zero map is the only collapsing case.":
    "كل تشاكل داخلي غير صفري للجبر الكامل عند n≥2 متباين، ولذلك هو تقابلي على الحامل المنتهي؛ والتطبيق الصفري هو حالة الطي الوحيدة.",
  ...
  "character chi sub s": "الطابع خي تحت s",
