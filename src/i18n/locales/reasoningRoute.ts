...
export const reasoningRouteRu: TranslationDictionary = {
  "Open possibilities": "Открыть возможности",
  "Keep alternatives": "Удержать альтернативы",
  "Test what separates them": "Проверить то, что их различает",
  "Assemble one lawful answer": "Собрать один допустимый ответ",
  "Take the outcome from outside": "Взять исход извне",
  "Record what is reusable": "Записать переиспользуемое",
  "Seal the episode": "Запечатать эпизод",
  "NEEDS MORE EVIDENCE": "НУЖНО БОЛЬШЕ СВИДЕТЕЛЬСТВ",
  "INVALID RUN": "НЕДОПУСТИМЫЙ ПРОГОН",
  "Seven phases stacked top to bottom, from opening the possibilities to sealing the episode, each joined to the next by an arrow and carrying its technical code beside its plain name. A dashed rail runs down the right of all seven and ends in two boxes, one for a lawful run that needs more evidence and one for an invalid run, so either exit is reachable from any phase.":
    "Семь фаз, поставленных сверху вниз — от открытия возможностей до запечатывания эпизода, — каждая соединена со следующей стрелкой и несёт свой технический код рядом с обычным названием. Справа вдоль всех семи идёт пунктирная рейка, заканчивающаяся двумя блоками: один для допустимого прогона, которому не хватило свидетельств, другой для недопустимого прогона. Любой из выходов достижим из любой фазы.",
  "CLOSED SET": "ЗАМКНУТЫЙ НАБОР",
  "ONE EPISODE · SEVEN PHASES": "ОДИН ЭПИЗОД · СЕМЬ ФАЗ",
  "One episode of GALO reasoning, drawn from opening to seal":
    "Один эпизод рассуждения GALO, нарисованный от открытия до печати",
  "One episode of reasoning, and the receipt it leaves": "Один эпизод рассуждения и квитанция, которую он оставляет",
  ...
  "candidates opened in full": "кандидаты открыты целиком",
  "maps built, structures reused": "карты построены, структуры взяты",
  "one distinguishing probe": "одна различающая проба",
  "one lawful whole, or none": "одно законное целое или ни одного",
  "sealed, and replayable by others": "запечатано и воспроизводимо другими",
  "the order changes, not the verdict": "меняется порядок, а не вердикт",
  "the outcome comes from outside": "исход приходит извне",
  "A STOP IS A RESULT": "ОСТАНОВКА — ЭТО РЕЗУЛЬТАТ",
  ...
  "An invariant was broken": "Нарушен инвариант",
  ...
  "Any change to what is permitted": "Любое изменение того, что разрешено",
  ...
  "Does one lawful whole come out of what survived?": "Складывается ли из выжившего одно законное целое?",
  "Durable state is updated, and only durable state": "Обновляется устойчивое состояние — и только оно",
  ...
  "Every shortcut has to be presentable": "Любое сокращение обязано быть предъявимым",
  "Every step has a price, and the budget is finite": "У каждого шага есть цена, и бюджет конечен",
  ...
  "Executable local maps are built": "Строятся исполнимые локальные карты",
  ...
  "GALO works out which candidate is best.": "GALO вычисляет, какой кандидат лучше.",
  "How GALO Thinks — The Route an Episode Travels": "Как мыслит GALO — маршрут, который проходит эпизод",
  "INSIDE ONE BOUNDED STEP": "ВНУТРИ ОДНОГО ОГРАНИЧЕННОГО ШАГА",
  "Inside one bounded step": "Внутри одного ограниченного шага",
  ...
  "Learning opens only after an outside disclosure": "Обучение открывается только после внешнего раскрытия",
  ...
  "No single lawful composition": "Нет единственной законной композиции",
  ...
  "Nothing is learned here, since there are no weights.": "Раз весов нет, то ничего и не выучивается.",
  ...
  "Nothing left to distinguish with": "Разделить больше нечем",
  "Nothing. Learning cannot reach the verdict.": "Ничего. Обучение до вердикта не дотягивается.",
  "ONE EPISODE, FROM OPENING TO SEAL": "ОДИН ЭПИЗОД — ОТ ОТКРЫТИЯ ДО ПЕЧАТИ",
  ...
  "One bounded step with concrete values": "Один ограниченный шаг с конкретными значениями",
  "One distinguishing probe is taken": "Берётся одна различающая проба",
  "One episode, phase by phase": "Один эпизод, фаза за фазой",
  ...
  "Proven structures and their lifecycle": "Доказанные структуры и их жизненный цикл",
  ...
  "Seven phases, and the set is closed.": "Семь фаз, и набор замкнут.",
  "Seven phases, and two ways out that are not the seventh.": "Семь фаз и два выхода, которые не являются восьмой.",
  ...
  "THE WHOLE ROUTE ON ONE SCREEN": "ВЕСЬ МАРШРУТ НА ОДНОМ ЭКРАНЕ",
  ...
  "The candidate space is opened": "Открывается пространство кандидатов",
  ...
  "The episode is sealed": "Эпизод запечатывается",
  ...
  "The episode's record": "Запись эпизода",
  ...
  "The learned volume": "Выученный том",
  "The outcome is disclosed from outside": "Исход раскрывается извне",
  "The outcome is typed, not scored": "Исход типизирован, а не оценён баллом",
  ...
  "The route an episode travels, phase by phase.": "Маршрут, который проходит эпизод, фаза за фазой.",
  ...
  "The route keeps going until it is satisfied.": "Маршрут идёт, пока не будет доволен.",
  ...
  "The route ran lawfully and could not settle it": "Маршрут прошёл законно и не смог это решить",
  "The run was not lawful, and is not repaired": "Запуск не был законным и не чинится",
  ...
  "The space could not be opened in full": "Пространство не удалось открыть целиком",
  "The surviving maps are composed": "Выжившие карты складываются",
  ...
  "The work budget is spent": "Бюджет работы исчерпан",
  ...
  "WHAT SURVIVES AN EPISODE": "ЧТО ПЕРЕЖИВАЕТ ЭПИЗОД",
  "WHY THIS IS A ROUTE AND NOT A SEARCH": "ПОЧЕМУ ЭТО МАРШРУТ, А НЕ ПОИСК",
  "What actually happened, according to somebody other than me?":
    "Что произошло на самом деле — по словам кого-то, кроме меня?",
  "What can somebody else replay from this?": "Что кто-то другой сможет по этому воспроизвести?",
  "What could lawfully happen here at all?": "Что здесь вообще может произойти законно?",
  ...
  "What would tell these readings apart?": "Что различило бы эти прочтения?",
  "Where an episode is allowed to stop": "Где эпизоду разрешено остановиться",
  "Which readings of this situation are lawful?": "Какие прочтения этой ситуации законны?",
  "Why this is a route and not a search": "Почему это маршрут, а не поиск",
  "Why this step learns nothing": "Почему этот шаг ничему не учится",
  ...
  "absent by construction, not merely unused": "отсутствуют по построению, а не просто не используются",
  "carried into the next episode": "переносится в следующий эпизод",
  "dashed: a lawful exit, reachable from any phase": "пунктир: законный выход, достижимый из любой фазы",
  "detach the volume and the same engine runs without it": "снимите том — и тот же движок работает без него",
  "lawful, unsettled": "законно, не решено",
  "solid: a phase of the route": "сплошная линия: фаза маршрута",
  "unlawful, refused": "незаконно, отклонено",
};

export const reasoningRouteZh: TranslationDictionary = {
  "Open possibilities": "打开可能性",
  "Keep alternatives": "保留多种解释",
  "Test what separates them": "检验能把它们分开的东西",
  "Assemble one lawful answer": "拼出一个合法的答案",
  "Take the outcome from outside": "结果由外部给出",
  "Record what is reusable": "记录可以再用的部分",
  "Seal the episode": "封存这一回合",
  "NEEDS MORE EVIDENCE": "证据不足",
  "INVALID RUN": "运行不合法",
  "Seven phases stacked top to bottom, from opening the possibilities to sealing the episode, each joined to the next by an arrow and carrying its technical code beside its plain name. A dashed rail runs down the right of all seven and ends in two boxes, one for a lawful run that needs more evidence and one for an invalid run, so either exit is reachable from any phase.":
    "七个阶段自上而下排开，从打开可能性一直到封存回合，每一个都用箭头连到下一个，并在通俗名称旁边带着自己的技术代号。右侧沿着这七个阶段有一条虚线的导轨，尽头是两个方块：一个表示合法运行但证据不足，另一个表示运行不合法。两个出口从任何一个阶段都能到达。",
  "CLOSED SET": "封闭集合",
  "ONE EPISODE · SEVEN PHASES": "一个回合 · 七个阶段",
  "One episode of GALO reasoning, drawn from opening to seal": "GALO 一个推理回合，从开启画到封存",
  "One episode of reasoning, and the receipt it leaves": "一个推理回合，以及它留下的回执",
  "Work is counted as it is spent, and either exit is reachable from any phase. A stop is a recorded outcome with a named cause, not a missing answer.":
    "工作量是边花边数的，而两个出口从任何一个阶段都能到达。停止是一个带具体成因、被记录下来的结果，而不是一个没给出来的答案。",
  "candidates opened in full": "候选被完整打开",
  "maps built, structures reused": "局部图建好，结构被复用",
  "one distinguishing probe": "一个能区分的探针",
  "one lawful whole, or none": "一个合法的整体，或者一个都没有",
  "sealed, and replayable by others": "已封存，别人可以重放",
  "the order changes, not the verdict": "变的是顺序，不是裁定",
  "the outcome comes from outside": "结果来自外部",
  "A STOP IS A RESULT": "停下来也是一种结果",
  "A boundary is returned naming what could not be separated, rather than the reading the route happens to find most plausible.":
  ...
  "An invariant was broken": "有一条不变式被破坏",
  "An upper band with three solid boxes labelled receipts, learned volume, and proven structures, and a lower band drawn with a dashed border containing two boxes labelled weights and wider verdict, each marked with a cross.":
    "上方一条带子里有三个实线方块，分别标记为回执、已学到的卷宗与已证明的结构；下方一条带子用虚线边框画出，里面是两个被打上叉号的方块：权重与更宽的裁定。",
  "Any change to what is permitted": "对「什么是被允许的」的任何改动",
  "Append-only and linked back to the observation it came from, so what was learned cannot be shown without the episodes that produced it. A record is read by people and by replay tooling, never by the decision path of a later episode.":
  ...
  "Does one lawful whole come out of what survived?": "从活下来的这些里，能不能出来一个合法的整体？",
  "Durable state is updated, and only durable state": "被更新的是持久状态，而且只有持久状态",
  "Each phase answers one question and hands one object to the next. The phase set is closed, so there is no unnamed state to fall into: an episode is either in one of the seven or on one of the two exits, and the exits are reachable from any phase rather than only from the end.":
  ...
  "Every shortcut has to be presentable": "任何抄近路都必须拿得出来",
  "Every step has a price, and the budget is finite": "每一步都有价钱，而预算是有限的",
  "Everything an episode leaves behind can be listed. That is what makes a later disagreement resolvable: two runs can be compared register by register instead of being argued about — and the learned volume can simply be removed, which is how every published learning number was measured.":
    "一个回合留下的一切都能列举出来。正是这一点让日后的分歧可解：两次运行可以逐个寄存器地比对，而不是互相争论——而且已学到的卷宗可以直接卸掉，每一个已公布的学习数字就是这么测出来的。",
  "Executable local maps are built": "构建可执行的局部图",
  "Four constraints do the work, and none of them is an intention.": "干活的是四条约束，而它们没有一条是「打算」。",
  "Four of the five below end in a boundary and one in a rejection, and the record says which. The difference matters: a boundary is a lawful run that could not settle the question, a rejection is a run that was not lawful at all. Collapsing the two would make every stop look the same.":
    "下面五条里有四条以边界收尾，一条以拒绝收尾，而记录会写明是哪一种。这个区别要紧：边界是一次合法的运行没能把问题定下来，拒绝是这次运行根本就不合法。把两者混在一起，所有的停止就都长成一个样子了。",
  "GALO works out which candidate is best.": "GALO 会算出哪个候选最好。",
  "How GALO Thinks — The Route an Episode Travels": "GALO 如何思考 — 一次推理所走的路线",
  "INSIDE ONE BOUNDED STEP": "在一个受限步骤的内部",
  "Inside one bounded step": "在一个受限步骤的内部",
  "It cannot. The budget is finite and counted as it is spent, and exhausting it is a lawful outcome with a named cause. An episode ends on a settled answer or on a boundary, never on having tried for long enough.":
  ...
  "Learning opens only after an outside disclosure": "学习只在外部揭示之后才打开",
  "No available probe would tell the surviving readings apart.": "现有的任何一个探针都区分不开活下来的那些读法。",
  "No external reveal is available, or the outcome it reports is not verified.":
  ...
  "No single lawful composition": "没有唯一的合法组合",
  "Nothing is chosen for being most plausible. When there is nothing to tell the alternatives apart, the route must take a probe or return a boundary. The one thing it may not do is hand back the likeliest reading as though it had been established.":
    "没有什么东西是因为「更像」而被选中的。当各种可能之间无从区分时，路线必须取一个探针，或者返回一个边界。它唯一不被允许做的，就是把最可能的那个读法当成已经确定的交回来。",
  "Nothing is learned here, since there are no weights.": "既然没有权重，那就什么也没学到。",
  "Nothing is scored. When the alternatives cannot be told apart, the route takes a probe or returns a boundary — it never hands back the most plausible one as though it had been established.":
    "什么都不打分。当各种可能分不开时，路线要么取探针，要么返回边界——它绝不会把最像的那个当成已经确定的交回来。",
  "Nothing left to distinguish with": "已经没有东西可以用来区分了",
  "Nothing. Learning cannot reach the verdict.": "什么也没有。学习够不到裁定。",
  "ONE EPISODE, FROM OPENING TO SEAL": "一个回合，从开启到封存",
  "One accepted observation carried through one bounded step": "一个被接受的观察，走完一个受限的步骤",
  "One bounded step with concrete values": "一个受限步骤，带上具体数值",
  "One distinguishing probe is taken": "取一个能区分的探针",
  "One episode, phase by phase": "一个回合，逐个阶段",
  "One episode in seven phases, with two lawful ways out of it": "一个回合走七个阶段，外加两个合法的出口",
  "One turn of the cycle": "循环走一圈",
  "Proven structures and their lifecycle": "已证明的结构，以及它们的生命周期",
  "Reachable from any phase, and a legitimate way for an episode to end.":
  ...
  "Seven phases, and the set is closed.": "七个阶段，而且集合是封闭的。",
  "Seven phases, and two ways out that are not the seventh.": "七个阶段，外加两个出口——而它们不是第八个阶段。",
  "Several readings survive and no available probe would separate them.":
    "有好几个读法活了下来，而现有的任何探针都分不开它们。",
  Step: "步骤",
  "Structures that passed the formation checks, each standing as active, weakened, or retired.":
    "通过了形成检查的结构，每一条都标着「有效」「被削弱」或「已退役」。",
  "THE WHOLE ROUTE ON ONE SCREEN": "整条路线，一屏之内",
  "The GALO reasoning route: seven phases and two lawful exits, where an episode is allowed to stop, one bounded step of the frozen release with its exact values, what survives an episode, and what the published results did not measure.":
    "GALO 的推理路线：七个阶段与两个合法出口、一次推理允许在何处停下、冻结版本那一步的确切数值、一次推理之后留下什么，以及已公布结果没有测到的部分。",
  "The candidate portfolio cannot be completed, or materialising it would exceed the declared limit.":
    "候选组合补不齐，或者把它铺开会超出声明的上限。",
  "The candidate space is opened": "打开候选空间",
  "The composition has to be unique up to lawful equivalence. Two inequivalent lawful compositions are not settled by preference: the route reports that it holds two of them and stops, because choosing between them would be exactly the unrecorded judgement this design exists to avoid.":
  ...
  "The learned volume": "已学到的卷宗",
  "The outcome is disclosed from outside": "结果由外部揭示",
  "The outcome is typed, not scored": "结果是带类型的，不是打分打出来的",
  "The outcome of the action is disclosed by an external evaluator, and its record is required before the route may continue.":
  ...
  "The route an episode travels, phase by phase.": "一次推理所走的路线，逐个阶段。",
  "The route drawn on this page is what the published results measured.":
    "这一页画出来的路线，就是已公布结果所测的东西。",
  "The route keeps going until it is satisfied.": "路线会一直走，直到它满意为止。",
  "The route may not confirm itself. Until an external evaluator discloses the outcome, no durable state may change, and an attempt to change it before that point is refused by name and written down.":
    "路线无权自己确认自己。在外部评估者揭示结果之前，任何持久状态都不能改；在那之前试图去改，会被按名拒绝并记录下来。",
  "The route ran lawfully and could not settle it": "路线走得合法，但没能把它定下来",
  "The run was not lawful, and is not repaired": "这次运行不合法，而且不予修补",
  "The set of probes and their cost are fixed before the episode begins. The policy may choose among them; it may not change them or reprice them. That is the rule which keeps a probe from turning into a way of justifying a conclusion already reached.":
    "探针的集合和它们的价钱在回合开始之前就定死了。策略可以在其中挑，但不能改动它们，也不能给它们重新定价。正是这条规则，让探针不至于变成给一个已经得出的结论找理由的手段。",
  "The seven phases of one GALO episode and its two lawful exits": "GALO 一个回合的七个阶段，以及它的两个合法出口",
  "The space could not be opened in full": "这个空间没能被完整打开",
  "The surviving maps are composed": "把活下来的局部图组合起来",
  "The surviving maps are composed into a single multi-place structure, and proven structures are applied again wherever they cover it.":
    "活下来的局部图被组合成一个多元结构，凡是已证明的结构能覆盖到的地方，就再一次被用上。",
  "The word names a written-out route with declared phases, a counted budget, and a typed outcome. No claim about cognition, understanding, or awareness is made here or anywhere else on this site.":
    "这个词指的是一条写明白的路线：阶段是声明好的，预算是数出来的，结果是带类型的。关于认知、理解或意识的任何主张，这里没有，这个网站别处也没有。",
  "The work budget is spent": "工作预算用完了",
  "There are no weights, and there is learning. What is learned is where to look and in what order, held in a volume that can be detached; what may never be learned is the verdict. The measured results, and the comparator they were measured against, are on the evidence page.":
  ...
  "WHAT SURVIVES AN EPISODE": "一个回合之后留下什么",
  "WHY THIS IS A ROUTE AND NOT A SEARCH": "为什么这是路线，不是搜索",
  "What actually happened, according to somebody other than me?": "按我以外的人的说法，实际发生的是什么？",
  "What can somebody else replay from this?": "别人能凭这些重放出什么？",
  "What could lawfully happen here at all?": "在这里，究竟什么才可能是合法发生的？",
  "What is updated is where to look and in what order — never what counts as permitted. A policy snapshot that has gone stale is refused rather than merged, so two independent replays of the same episode land on the same state rather than on two nearly identical ones.":
    "被更新的是「去哪里找、按什么次序找」——而绝不是「什么算被允许」。过期的策略快照是被拒绝的，不是被合并的，所以同一个回合的两次独立重放会落到同一个状态上，而不是两个几乎一样的状态上。",
  "What may I keep from this, and what may I never keep?": "这里面哪些我可以留下来，哪些我永远不能留？",
  "What survives an episode": "一个回合之后留下什么",
  "What the counted work actually came to, and against which comparator":
    "数出来的工作量最后落到多少，又是对着什么比较基准",
  "What was checked, what was probed, what ran, what was refused, and how much work it cost.":
    "检查了什么、探了什么、跑了什么、拒了什么，以及这一切花掉多少工作量。",
  "What would tell these readings apart?": "什么东西能把这些读法分开？",
  "Where an episode is allowed to stop": "一个回合允许在哪里停下",
  "Which readings of this situation are lawful?": "对这个局面，哪些读法是合法的？",
  "Why this is a route and not a search": "为什么这是路线，不是搜索",
  "Why this step learns nothing": "为什么这一步什么也学不到",
  "Without an external reveal the route has no right to learn. This is the single rule that separates learning from self-confirmation: a system allowed to score its own outcomes can improve its numbers indefinitely without improving anything else.":
  ...
  "absent by construction, not merely unused": "按构造就不在，而不只是没被用上",
  "carried into the next episode": "带进下一个回合",
  "dashed: a lawful exit, reachable from any phase": "虚线：合法出口，从任何阶段都能到达",
  "detach the volume and the same engine runs without it": "把卷宗卸掉，同一个引擎照样跑",
  "lawful, unsettled": "合法，未定",
  "solid: a phase of the route": "实线：路线的一个阶段",
  "unlawful, refused": "不合法，已拒绝",
};

export const reasoningRouteAr: TranslationDictionary = {
  "Open possibilities": "فتح الاحتمالات",
  "Keep alternatives": "الإبقاء على البدائل",
  "Test what separates them": "اختبار ما يفرّق بينها",
  "Assemble one lawful answer": "تركيب جوابٍ مشروعٍ واحد",
  "Take the outcome from outside": "أخذ النتيجة من الخارج",
  "Record what is reusable": "تسجيل ما يصلح لإعادة الاستعمال",
  "Seal the episode": "ختم الحلقة",
  "NEEDS MORE EVIDENCE": "يحتاج أدلّةً أكثر",
  "INVALID RUN": "تشغيلٌ غير مشروع",
  "Seven phases stacked top to bottom, from opening the possibilities to sealing the episode, each joined to the next by an arrow and carrying its technical code beside its plain name. A dashed rail runs down the right of all seven and ends in two boxes, one for a lawful run that needs more evidence and one for an invalid run, so either exit is reachable from any phase.":
    "سبع مراحل مرصوفة من الأعلى إلى الأسفل، من فتح الاحتمالات إلى ختم الحلقة، كلٌّ منها موصولةٌ بالتالية بسهم وتحمل رمزها التقنيّ إلى جانب اسمها المألوف. وعلى اليمين يمتدّ بمحاذاة السبع جميعًا قضيبٌ متقطّع ينتهي إلى مربّعين: أحدهما لتشغيلٍ مشروعٍ لم تكفِه الأدلّة، والآخر لتشغيلٍ غير مشروع، فكلا المخرجين يُبلَغ من أي مرحلة.",
  "CLOSED SET": "مجموعة مغلقة",
  "ONE EPISODE · SEVEN PHASES": "حلقة واحدة · سبع مراحل",
  "One episode of GALO reasoning, drawn from opening to seal":
    "حلقةُ استدلالٍ واحدة في GALO، مرسومةً من الفتح إلى الختم",
  "One episode of reasoning, and the receipt it leaves": "حلقةُ استدلالٍ واحدة والإيصال الذي تتركه",
  "Work is counted as it is spent, and either exit is reachable from any phase. A stop is a recorded outcome with a named cause, not a missing answer.":
    "يُحسَب العمل وهو يُنفَق، وكلا المخرجين يُبلَغ من أي مرحلة. والتوقّف نتيجةٌ مسجَّلة بسببٍ مسمّى لا جوابًا غائبًا.",
  "candidates opened in full": "المرشحون مفتوحون كاملًا",
  "maps built, structures reused": "خرائط تُبنى وبنى تُعاد",
  "one distinguishing probe": "مسبارٌ فارقٌ واحد",
  "one lawful whole, or none": "كلٌّ مشروعٌ واحد أو لا شيء",
  "sealed, and replayable by others": "مختومٌ ويُعيد تشغيله غيرك",
  "the order changes, not the verdict": "يتغيّر الترتيب لا الحكم",
  "the outcome comes from outside": "النتيجة تأتي من الخارج",
  "A STOP IS A RESULT": "التوقف نتيجة",
  "A boundary is returned naming what could not be separated, rather than the reading the route happens to find most plausible.":
  ...
  "An invariant was broken": "انتُهك لازم",
  "An upper band with three solid boxes labelled receipts, learned volume, and proven structures, and a lower band drawn with a dashed border containing two boxes labelled weights and wider verdict, each marked with a cross.":
  ...
  "Any change to what is permitted": "أيّ تغييرٍ لما هو مسموح به",
  "Append-only and linked back to the observation it came from, so what was learned cannot be shown without the episodes that produced it. A record is read by people and by replay tooling, never by the decision path of a later episode.":
  ...
  "Does one lawful whole come out of what survived?": "هل يخرج من الباقي كلٌّ مشروعٌ واحد؟",
  "Durable state is updated, and only durable state": "تُحدَّث الحالة الدائمة، ولا شيء سواها",
  "Each phase answers one question and hands one object to the next. The phase set is closed, so there is no unnamed state to fall into: an episode is either in one of the seven or on one of the two exits, and the exits are reachable from any phase rather than only from the end.":
  ...
  "Every shortcut has to be presentable": "كلُّ اختصارٍ يجب أن يكون قابلًا للإبراز",
  "Every step has a price, and the budget is finite": "لكلِّ خطوةٍ ثمن، والميزانية منتهية",
  "Everything an episode leaves behind can be listed. That is what makes a later disagreement resolvable: two runs can be compared register by register instead of being argued about — and the learned volume can simply be removed, which is how every published learning number was measured.":
  ...
  "Executable local maps are built": "تُبنى خرائط محلية قابلة للتنفيذ",
  "Four constraints do the work, and none of them is an intention.":
  ...
  "GALO works out which candidate is best.": "يستنتج GALO أيُّ المرشحين أفضل.",
  "How GALO Thinks — The Route an Episode Travels": "كيف يفكّر GALO — المسار الذي تسلكه الحلقة",
  "INSIDE ONE BOUNDED STEP": "داخل خطوةٍ واحدة محدودة",
  "Inside one bounded step": "داخل خطوةٍ واحدة محدودة",
  "It cannot. The budget is finite and counted as it is spent, and exhausting it is a lawful outcome with a named cause. An episode ends on a settled answer or on a boundary, never on having tried for long enough.":
  ...
  "Learning opens only after an outside disclosure": "لا يُفتح التعلُّم إلا بعد كشفٍ من الخارج",
  "No available probe would tell the surviving readings apart.": "لا مسبار متاح يفرّق بين القراءات الباقية.",
  "No external reveal is available, or the outcome it reports is not verified.":
  ...
  "No single lawful composition": "لا تركيب مشروع واحد",
  "Nothing is chosen for being most plausible. When there is nothing to tell the alternatives apart, the route must take a probe or return a boundary. The one thing it may not do is hand back the likeliest reading as though it had been established.":
  ...
  "Nothing is learned here, since there are no weights.": "ما دامت لا أوزان، فلا تعلُّمَ إذن.",
  "Nothing is scored. When the alternatives cannot be told apart, the route takes a probe or returns a boundary — it never hands back the most plausible one as though it had been established.":
    "لا شيء يُسجَّل بدرجة. وحين يتعذّر التمييز بين البدائل، يأخذ المسار مسبارًا أو يعيد حدًّا — ولا يعيد الأرجح قطُّ وكأنه ثبت.",
  "Nothing left to distinguish with": "لم يبقَ ما يُفرَّق به",
  "Nothing. Learning cannot reach the verdict.": "لا شيء. لا يبلغ التعلُّمُ الحكمَ.",
  "ONE EPISODE, FROM OPENING TO SEAL": "حلقةٌ واحدة، من الفتح إلى الختم",
  "One accepted observation carried through one bounded step": "ملاحظةٌ واحدة مقبولة تُمرَّر عبر خطوةٍ واحدة محدودة",
  "One bounded step with concrete values": "خطوةٌ واحدة محدودة بقيمٍ محدَّدة",
  "One distinguishing probe is taken": "يُؤخذ مسبارٌ فارقٌ واحد",
  "One episode, phase by phase": "حلقةٌ واحدة، مرحلةً مرحلة",
  "One episode in seven phases, with two lawful ways out of it": "حلقةٌ واحدة في سبع مراحل، ولها مخرجان مشروعان",
  "One turn of the cycle": "دورةٌ واحدة",
  "Proven structures and their lifecycle": "البنى المُثبَتة ودورة حياتها",
  "Reachable from any phase, and a legitimate way for an episode to end.":
  ...
  "Seven phases, and the set is closed.": "سبع مراحل، والمجموعة مغلقة.",
  "Seven phases, and two ways out that are not the seventh.": "سبع مراحل، ومخرجان ليسا المرحلة الثامنة.",
  "Several readings survive and no available probe would separate them.": "تبقى عدة قراءات ولا مسبار متاح يفصل بينها.",
  Step: "الخطوة",
  "Structures that passed the formation checks, each standing as active, weakened, or retired.":
    "بنى اجتازت فحوص التكوُّن، كلٌّ منها قائمةٌ بوصفها فعّالة أو مُضعَفة أو مُتقاعِدة.",
  "THE WHOLE ROUTE ON ONE SCREEN": "المسار كلّه في شاشةٍ واحدة",
  "The GALO reasoning route: seven phases and two lawful exits, where an episode is allowed to stop, one bounded step of the frozen release with its exact values, what survives an episode, and what the published results did not measure.":
  ...
  "The candidate space is opened": "يُفتح فضاء المرشحين",
  "The composition has to be unique up to lawful equivalence. Two inequivalent lawful compositions are not settled by preference: the route reports that it holds two of them and stops, because choosing between them would be exactly the unrecorded judgement this design exists to avoid.":
  ...
  "The episode is sealed": "تُختَم الحلقة",
  "The episode opens, the space of lawful candidates is materialised, and the portfolio is checked for completeness before anything is chosen.":
  ...
  "The episode's record": "سجلّ الحلقة",
  "The evidence did not distinguish, no lawful composition was unique, no external reveal was available, or the counted budget ran out. In each case the cause is named in the record, so a stop is something a reader can examine rather than an absence of output.":
  ...
  "The learned volume": "الرصيد المُتعلَّم",
  "The outcome is disclosed from outside": "تُكشَف النتيجة من الخارج",
  "The outcome is typed, not scored": "النتيجة محددة النوع لا مُسجَّلة بدرجة",
  "The outcome of the action is disclosed by an external evaluator, and its record is required before the route may continue.":
  ...
  "The route an episode travels, phase by phase.": "المسار الذي تسلكه الحلقة، مرحلةً مرحلة.",
  "The route drawn on this page is what the published results measured.":
    "المسار المرسوم في هذه الصفحة هو ما قاسته النتائج المنشورة.",
  "The route keeps going until it is satisfied.": "يمضي المسار حتى يرضى.",
  "The route may not confirm itself. Until an external evaluator discloses the outcome, no durable state may change, and an attempt to change it before that point is refused by name and written down.":
  ...
  "The route ran lawfully and could not settle it": "جرى المسار مشروعًا ولم يستطع حسمه",
  "The run was not lawful, and is not repaired": "لم يكن التشغيل مشروعًا، ولا يُصلَح",
  "The set of probes and their cost are fixed before the episode begins. The policy may choose among them; it may not change them or reprice them. That is the rule which keeps a probe from turning into a way of justifying a conclusion already reached.":
  ...
  "The seven phases of one GALO episode and its two lawful exits": "المراحل السبع لحلقة GALO ومخرجاها المشروعان",
  "The space could not be opened in full": "تعذّر فتح الفضاء كاملًا",
  "The surviving maps are composed": "تُركَّب الخرائط الباقية",
  "The surviving maps are composed into a single multi-place structure, and proven structures are applied again wherever they cover it.":
  ...
  "The work budget is spent": "نفدت ميزانية العمل",
  "There are no weights, and there is learning. What is learned is where to look and in what order, held in a volume that can be detached; what may never be learned is the verdict. The measured results, and the comparator they were measured against, are on the evidence page.":
  ...
  "WHAT SURVIVES AN EPISODE": "ما الذي يبقى بعد الحلقة",
  "WHY THIS IS A ROUTE AND NOT A SEARCH": "لماذا هذا مسارٌ لا بحث",
  "What actually happened, according to somebody other than me?": "ما الذي حدث فعلًا، بحسب أحدٍ غيري؟",
  "What can somebody else replay from this?": "ما الذي يستطيع غيري أن يُعيد تشغيله من هذا؟",
  "What could lawfully happen here at all?": "ما الذي يمكن أن يحدث هنا مشروعًا أصلًا؟",
  "What is updated is where to look and in what order — never what counts as permitted. A policy snapshot that has gone stale is refused rather than merged, so two independent replays of the same episode land on the same state rather than on two nearly identical ones.":
  ...
  "What would tell these readings apart?": "ما الذي يفرّق بين هذه القراءات؟",
  "Where an episode is allowed to stop": "أين يُسمح للحلقة بالتوقف",
  "Which readings of this situation are lawful?": "أيُّ قراءاتِ هذا الموقف مشروعة؟",
  "Why this is a route and not a search": "لماذا هذا مسارٌ لا بحث",
  "Why this step learns nothing": "لماذا لا تتعلّم هذه الخطوة شيئًا",
  "Without an external reveal the route has no right to learn. This is the single rule that separates learning from self-confirmation: a system allowed to score its own outcomes can improve its numbers indefinitely without improving anything else.":
  ...
  "absent by construction, not merely unused": "غائبان بحكم البناء لا لكونهما غير مستعملين",
  "carried into the next episode": "يُحمَل إلى الحلقة التالية",
  "dashed: a lawful exit, reachable from any phase": "متقطّع: مخرجٌ مشروع يُبلَغ من أي مرحلة",
  "detach the volume and the same engine runs without it": "انزع الرصيد ويعمل المحرك نفسه من دونه",
  "lawful, unsettled": "مشروع، غير محسوم",
  "solid: a phase of the route": "متّصل: مرحلة من المسار",
  "unlawful, refused": "غير مشروع، مرفوض",
};
