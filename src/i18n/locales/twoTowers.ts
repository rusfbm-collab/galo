...
export const twoTowersRu: TranslationDictionary = {
  "A left P0 absorbs":
    "Левый P0 поглощает",
  "Asks about a reset first":
    "Сначала проверяет сброс",
  "Associative":
    "Ассоциативна",
  ...
  "Every pole has an inverse":
    "У каждого полюса есть обратный",
  "Folds down in {folds} ways":
    "Складывается вниз {folds} способами",
  "Moves around the dial":
    "Ходит по циферблату",
  "Never folds down":
    "Никогда не складывается вниз",
  "Nonassociative at n ≥ 2":
    "Неассоциативна при n ≥ 2",
  "Noncommutative at n ≥ 2":
    "Некоммутативна при n ≥ 2",
  ...
  "Why seven levels and not one":
    "Почему семь уровней, а не один",
  "Why two and not one":
    "Почему две, а не одна",
  "marked: a level that folds onto a lower one":
    "отмечено: уровень, который складывается на нижний",
};
...
export const twoTowersAr: TranslationDictionary = {
  ...
  "WHAT IS IN THE CORE":
    "ما الذي في النواة",
  "What this does not establish":
    "ما الذي لا يُثبته هذا",
  "Why seven levels and not one":
    "لماذا سبعة مستويات لا مستوى واحد",
  "Why two and not one":
    "لماذا اثنان لا واحد",
  "marked: a level that folds onto a lower one":
    "معلَّم: مستوى يُطوى إلى مستوًى أدنى",
};
