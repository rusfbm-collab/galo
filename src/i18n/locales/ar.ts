...
import { theoryPlainAr } from "./theoryPlain";
...
import { tableSpaceAr } from "./tableSpace";
import { twoTowersAr } from "./twoTowers";
...
export const ar: TranslationDictionary = {
  ...
  "Research architecture for decisions that have to be defensible afterwards: what was permitted, what was chosen, and a record anyone can replay.":
    "بنيةٌ بحثية للقرارات التي يُسأل عنها لاحقًا: ما الذي كان مباحًا، وما الذي وقع عليه الاختيار، وسِجِلٌّ يستطيع أيُّ أحد أن يُعيد تشغيله.",
  "Working bounded prototype. Persistent learning, external operational gain, General AI, commercial traction, and programme selection are not claimed.":
    "نموذجٌ أوّليّ يعمل، محدودُ النطاق. ولا ندّعي تعلّمًا مستديمًا، ولا مكسبًا تشغيليًّا خارجيًّا، ولا ذكاءً اصطناعيًّا عامًّا، ولا رواجًا تجاريًّا، ولا قَبولًا في أيّ برنامج.",
  ...
  "Agentic AI is moving faster than its reasoning state can be governed.":
    "يتقدّم الذكاء الاصطناعي الوكيلي أسرعَ ممّا تتقدّم القدرةُ على حوكمة حالة استدلاله.",
  "Models can produce increasingly capable outputs, while the authoritative state behind long-running decisions can remain implicit, transient, or difficult to revise locally.":
    "تستطيع النماذج أن تُخرج نتائج أقدرَ فأقدر، بينما تبقى الحالةُ المرجعية وراء القرارات الطويلة الأمد ضمنيةً أو عابرةً أو عصيّةً على المراجعة الموضعية.",
  "Implicit world state": "حالة عالم ضمنية",
  "A system can answer without exposing the durable model behind the answer.":
    "يستطيع النظام أن يُجيب من غير أن يكشف النموذجَ المستديم الكامن وراء الجواب.",
  ...
  "Prompts, retrieved context, and memory updates can alter behaviour without a discrete, inspectable state transition.":
    "قد تُغيّر المطالباتُ والسياقُ المسترجَع وتحديثاتُ الذاكرة السلوكَ من غير انتقال حالةٍ منفصلٍ قابلٍ للفحص.",
  ...
  "Several plausible explanations can be compressed into one output before evidence warrants a unique decision.":
    "قد تُختزل تفسيراتٌ عدّة، كلُّها معقول، في مُخرَجٍ واحد قبل أن تُسوِّغ الأدلّةُ قرارًا بعينه.",
  ...
  "A local counterexample may require a broad prompt, memory, or model change that affects unrelated behaviour.":
    "قد يستدعي مثالٌ مضادٌّ في موضعٍ واحد تعديلًا واسعًا في المطالبة أو الذاكرة أو النموذج، فيمسّ سلوكًا لا صلة له بالأمر.",
  ...
  "Designed to increase reasoning resolution only when a lower-dimensional representation loses a task-relevant distinction.":
    "صُمِّمت لترفع دقّة الاستدلال في حالةٍ واحدة: حين يُضيّع تمثيلٌ أقلُّ أبعادًا تمييزًا تحتاجه المهمّة.",
  ...
  "Designed so a counterexample can invalidate an affected map or assumption without forcing a global reset.":
    "صُمِّمت بحيث يُبطل المثالُ المضادّ الخريطةَ أو الافتراضَ الذي مسّه وحده، من غير أن يفرض إعادة ضبطٍ شاملة.",
  ...
  "The current bounded slice admits actions through typed contracts and records their execution through receipts.":
    "تقبل الشريحةُ المقيّدة الحالية الإجراءات عبر عقودٍ محدَّدة الأنواع، وتُسجّل تنفيذها في إيصالات.",
  ...
  "The architectural proposal separates adaptive ordering from formal admission. Persistent adaptive ordering remains in development.":
    "يفصل المقترح المعماري بين الترتيب التكيّفي والقَبول الشكلي. وما زال الترتيب التكيّفي المستديم قيد التطوير.",
  ...
  "Authenticated observation": "ملاحظة موثَّقة",
  ...
  "A trained Atlas is not present. Observation-conditioned structural reasoning and persistent learning are not implemented in the current release.":
    "لا وجود لـ Atlas مدرَّب. والاستدلالُ البنيوي المشروط بالملاحظة والتعلّمُ المستديم غير منفَّذَين في الإصدار الحالي.",
  "MINIMAL SUFFICIENT RESOLUTION": "الحد الأدنى الكافي من الدقة",
  ...
  "Designed behaviour. External validation remains a target milestone.":
    "سلوكٌ مقصودٌ في التصميم. وما زال التحقّق الخارجي هدفًا لم يُبلَغ بعد.",
  ...
  "This deterministic walkthrough uses sanitized identifiers from the current direct selfcheck. It does not generate a semantic answer and it does not adapt to the input observation.":
    "يستعمل هذا العرضُ الحتمي معرّفات منقّحة مأخوذة من الفحص الذاتي الجاري الآن. وهو لا يولّد جوابًا دلاليًّا ولا يتكيّف مع الملاحظة المُدخَلة.",
  ...
  "Authenticated external source": "مصدر خارجي موثَّق",
  ...
  "The numbers below describe formal inventory and release reproducibility. None is presented as a measure of intelligence, customer value, or external operational gain.":
    "تصف الأرقام أدناه المخزون الشكلي وقابلية إعادة إنتاج الإصدار. وليس واحدٌ منها مقياسًا للذكاء، ولا لقيمة العملاء، ولا للمكسب التشغيلي الخارجي.",
  ...
  "Across 756 coverage cells in the declared binary, one-step scope.":
    "موزّعة على 756 خلية تغطية داخل النطاق المعلن: ثنائيّ، بخطوة واحدة.",
  ...
  "Authenticated external-source provenance": "منشأ موثَّق لمصدر خارجي",
  ...
  "GALO is seeking partner-owned sequential data and a falsifiable evaluation environment where explicit state, late evidence, local revision, and deterministic replay matter.":
    "يبحث GALO عن بيانات تسلسلية يملكها الشريك، وعن بيئة تقييمٍ تقبل التفنيد، يكون فيها وزنٌ حقيقيّ للحالة الصريحة وللأدلّة المتأخّرة وللمراجعة الموضعية ولإعادة التشغيل الحتمية.",
  ...
  "Authenticated source custody": "عهدة مصدر موثَّقة",
  ...
  "Long-running systems where the authoritative decision state must be inspected and replayed.":
    "أنظمة طويلة الأمد لا بدّ فيها من فحص حالة القرار المرجعية وإعادةِ تشغيلها.",
  ...
  "Access to research, compute, engineering, and infrastructure relationships relevant to a private technical evaluation.":
    "الوصول إلى علاقاتٍ في البحث والحوسبة والهندسة والبنية التحتية، ذات صلة بتقييمٍ تقنيّ خاصّ.",
  ...
  "Bring partner-owned sequential data, a falsifiable outcome, and a setting where explicit state and replay matter.":
    "أحضر بيانات تسلسلية يملكها الشريك، ونتيجةً تقبل التفنيد، وبيئةً يكون فيها للحالة الصريحة ولإعادة التشغيل وزنٌ حقيقي.",
  ...
  "Architecture statements describe the design. Implemented and bounded statements describe the current release. They are not interchangeable.":
    "تصف عباراتُ البنية التصميمَ، وتصف العباراتُ المنفَّذة والمقيَّدة الإصدارَ الحالي. ولا تنوب إحداهما عن الأخرى.",
  ...
  "The architecture specifies a versioned World Atlas; a trained Atlas is not present.":
    "تنصّ البنية على World Atlas مُدارٍ بالإصدارات؛ ولا وجود لـ Atlas مدرَّب.",
  ...
  "A trained Atlas is not present.": "لا يوجد Atlas مدرَّب.",
  ...
  "The hosting provider may process technical request logs for security and service delivery. If you choose an external email, Telegram, or social link after one is published, you leave this website and the destination service’s terms and privacy practices apply.":
    "قد يعالج مزوّد الاستضافة سجلّات الطلبات التقنية لأغراض الأمن وتقديم الخدمة. وإذا تبعت رابطًا خارجيًّا للبريد الإلكتروني أو Telegram أو الشبكات الاجتماعية، فقد غادرت هذا الموقع، وسرت عليك عندئذٍ شروطُ الخدمة وممارساتُ الخصوصية الخاصّة بالجهة التي انتقلت إليها.",
