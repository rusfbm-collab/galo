...
export const industrialRu: TranslationDictionary = {
  ...
  "A verifiable world model for private AI and industrial autonomy.": "Проверяемая модель мира — для приватного ИИ и промышленной автономности.",
  ...
  "GENERAL-PURPOSE ARCHITECTURE · INDUSTRIAL DECISION ASSURANCE FIRST": "АРХИТЕКТУРА ОБЩЕГО НАЗНАЧЕНИЯ · НАЧИНАЕМ С ПРОМЫШЛЕННЫХ РЕШЕНИЙ",
