...
export const industrialRu: TranslationDictionary = {
  ...
  "Decision assurance around the digital twins a plant already runs.": "Решение, которое можно отстоять, — там, где на заводе уже работают цифровые двойники.",
  ...
  "GENERAL-PURPOSE ARCHITECTURE · INDUSTRIAL DECISION ASSURANCE FIRST": "АРХИТЕКТУРА ОБЩЕГО НАЗНАЧЕНИЯ · ПЕРВЫМИ ИДУТ ЗАВОДЫ",
