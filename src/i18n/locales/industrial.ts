...
export const industrialRu: TranslationDictionary = {
  "GALO is a general-purpose architecture for keeping a decision system's state, its permitted actions and the route it took explicit, rather than inside a model nobody can open. The first thing it is sold as is much narrower: decision assurance around the digital twins and operational systems an industrial plant already runs.": "GALO — это архитектура общего назначения, которая держит явными состояние системы принятия решений, её разрешённые действия и пройденный маршрут, вместо того чтобы прятать их внутри модели, которую никто не может открыть. То, что продаётся первым, гораздо уже: гарантия решений вокруг цифровых двойников и рабочих систем, которые на промышленном предприятии уже стоят.",
  "It is aimed at work where the expensive failure is not a wrong answer but a wrong answer nobody can trace: industrial operations, regulated processes, long-running automation, and anything a reviewer has to sign. Industry comes first because the cost of ambiguity is already counted there.": "Он рассчитан на работу, где дорого обходится не неверный ответ, а неверный ответ, который никто не может проследить: промышленная эксплуатация, регулируемые процессы, долгоживущая автоматизация и всё, что рецензенту приходится подписывать. Промышленность идёт первой потому, что цена неоднозначности там уже посчитана.",
  ...
  "The architecture is general; the first thing anybody would buy is not. What that first product is, what it would cost as a planning hypothesis, and how far it is from touching a machine:": "Архитектура — общая; первое, что кто-либо купит, — нет. Что это за первый продукт, во сколько он обошёлся бы как плановая гипотеза и насколько он далёк от того, чтобы коснуться машины:",
  ...
  "the industrial wedge, in full": "промышленный клин — целиком",
  ...
  "A candidate diagnosis and a portfolio of candidate actions.": "Кандидатный диагноз и портфель кандидатных действий.",
  ...
  "A post-reveal oracle, never promotable.": "Оракул после раскрытия, никогда не продвигается.",
  ...
  "A verifiable world model for private AI and industrial autonomy.": "Проверяемая модель мира для частного ИИ и промышленной автономности.",
  ...
  "Alternatives are kept while the evidence does not settle them.": "Альтернативы сохраняются, пока свидетельства их не разводят.",
  "An alarm arrives. Seven steps later there is a package somebody else can replay.": "Приходит авария. Через семь шагов есть пакет, который посторонний может воспроизвести.",
  ...
  "Annual": "Ежегодно",
  "Annual runtime and Atlas licence": "Годовая лицензия на runtime и Atlas",
  ...
  "Broader general-purpose reasoning": "Более широкое рассуждение общего назначения",
  ...
  "Commercial wedge": "Коммерческий клин",
  "Commit": "Фиксация",
  ...
  "Decision assurance around the digital twins a plant already runs.": "Гарантия решений вокруг цифровых двойников, которые на заводе уже работают.",
  "Delay already costs money": "Задержка уже стоит денег",
  "Design-partner planning hypotheses · not current prices": "Плановые гипотезы для работы с партнёром · не действующие цены",
  "Digital twin · SCADA · historian · MES · ERP · CMMS · manuals · sensors": "Цифровой двойник · SCADA · историан · MES · ERP · CMMS · руководства · датчики",
  "Digital twin, telemetry, work order, manual revision.": "Цифровой двойник, телеметрия, наряд на работу, редакция руководства.",
  ...
  "GALO AI for Industry — Decision Assurance Around Existing Digital Twins": "GALO AI для промышленности — гарантия решений вокруг существующих цифровых двойников",
  ...
  "GALO keeps state, learned search, local revision and action routes explicit — starting with decision assurance around the digital twins and operational systems a plant already runs. What is proven today is scoped: learning results on synthetic tasks and public benchmarks, published together with the two that did not work. No partner has yet run one on their own data, and nothing here authorises a command to a plant.": "GALO держит состояние, обучаемый поиск, локальный пересмотр и маршруты действий явными — начиная с гарантии решений вокруг цифровых двойников и рабочих систем, которые на заводе уже стоят. Доказано на сегодня ограниченное: результаты обучения на синтетических задачах и публичных бенчмарках, опубликованные вместе с двумя, которые не сработали. Ни один партнёр ещё не прогонял это на своих данных, и ничто здесь не разрешает команду на завод.",
  "GENERAL-PURPOSE ARCHITECTURE · INDUSTRIAL DECISION ASSURANCE FIRST": "АРХИТЕКТУРА ОБЩЕГО НАЗНАЧЕНИЯ · СНАЧАЛА ГАРАНТИЯ ПРОМЫШЛЕННЫХ РЕШЕНИЙ",
  "General-purpose architecture, not general intelligence. Partner-controlled validity is not proven, production autonomy is not authorised, and there is no customer, letter of intent or revenue.": "Архитектура общего назначения — не общий интеллект. Валидность, подтверждённая партнёром, не доказана, производственная автономность не разрешена, и нет ни клиента, ни письма о намерениях, ни выручки.",
  ...
  "Hardware and software in the loop, certified interlocks, and regulator or partner approval.": "Аппаратура и софт в контуре, сертифицированные блокировки и одобрение регулятора или партнёра.",
  "Heldout integrity": "Целостность отложенной выборки",
  "Historical ground truth, or an independent expert judgement.": "Историческая наземная истина или независимое экспертное суждение.",
  ...
  "Independent cross-domain evidence. Not a marketing declaration.": "Независимое межпредметное свидетельство. Не маркетинговая декларация.",
  ...
  "Industrial decision assurance around existing digital twins": "Гарантия промышленных решений вокруг существующих цифровых двойников",
  "Industrial decision-assurance evaluation": "Оценка гарантии промышленных решений",
  "Industry is chosen because the cost of ambiguity, downtime and an unsafe action is already measured there. A narrow market with measurable stakes falsifies an architecture faster than a broad one without them.": "Промышленность выбрана потому, что цена неоднозначности, простоя и небезопасного действия там уже посчитана. Узкий рынок с измеримой ставкой опровергает архитектуру быстрее, чем широкий без неё.",
  ...
  "Learn": "Учиться",
  "Learned proposal and search": "Обучаемое предложение и поиск",
  ...
  "Most plants are not suitable, and saying so early is part of the product.": "Большинство заводов не подходят, и сказать это заранее — часть продукта.",
  ...
  "No historian or SCADA, no asset hierarchy, no maintenance record, no versioned procedures.": "Ни историана, ни SCADA, ни иерархии активов, ни записей об обслуживании, ни версионированных процедур.",
  ...
  "Observe": "Наблюдать",
  "Offer": "Предложение",
  "One Atlas, typed programs, a learning contract and a replay contract, intended to hold across knowledge, science, industrial operations and autonomous missions. Domain changes the adapters and the sources; it does not change the evidence cycle.": "Один Atlas, типизированные программы, контракт обучения и контракт воспроизведения, рассчитанные держаться и на знаниях, и в науке, и в промышленной эксплуатации, и в автономных миссиях. Область меняет адаптеры и источники; она не меняет цикл доказательства.",
  ...
  "Planning hypotheses for a design-partner conversation, and nothing more.": "Плановые гипотезы для разговора с партнёром по разработке — и ничего больше.",
  "Planning hypothesis": "Плановая гипотеза",
  "Planning price hypotheses": "Гипотезы плановых цен",
  "Plant and asset twins, telemetry integration, 3D context and simulation": "Двойники заводов и активов, интеграция телеметрии, 3D-контекст и симуляция",
  "Platform and product, kept apart": "Платформа и продукт, порознь",
  "Platform thesis": "Тезис платформы",
  "Pointwise harm": "Точечный вред",
  "Policy and Atlas update receipts.": "Расписки об обновлении политики и Atlas.",
  ...
  "Request a bounded industrial evaluation": "Запросить ограниченную промышленную оценку",
  "Retrieval plus reranking, or the partner's own model workflow, with equal information.": "Поиск с переранжированием либо собственный модельный процесс партнёра, при равной информации.",
  ...
  "Reveal": "Раскрыть",
  "Review the technical evidence": "Посмотреть техническое обоснование",
  ...
  "SEVEN ARMS AND EIGHT GATES": "СЕМЬ ВЕТВЕЙ И ВОСЕМЬ ВОРОТ",
  ...
  "Seven arms and eight gates": "Семь ветвей и восемь ворот",
  "Shadow-mode reliability, a safety case, and an independent operational review.": "Надёжность в теневом режиме, обоснование безопасности и независимый эксплуатационный обзор.",
  ...
  "Synthetic L3–L7 tasks. Nothing industrial, and nothing about an operating plant.": "Синтетические задачи L3–L7. Ничего промышленного и ничего о работающем заводе.",
  ...
  "The causal same-mechanism comparator.": "Причинный компаратор на том же механизме.",
  ...
  "The same data for every arm.": "Одни и те же данные для каждой ветви.",
  ...
  "Two design partners in industrial digital twins, plant operations or autonomous systems, able to define a bounded evaluation on their own data with a success condition they write themselves.": "Два партнёра по разработке в области промышленных цифровых двойников, эксплуатации заводов или автономных систем, способные определить ограниченную оценку на своих данных с условием успеха, которое они формулируют сами.",
  ...
  "What has to be true before anything is promoted": "Что должно стать правдой, прежде чем что-то будет повышено",
  "What it would cost, as a hypothesis": "Сколько это стоило бы, как гипотеза",
  "What the wedge is for": "Для чего нужен этот клин",
  ...
  "Where a person or a simulation stands between the reasoning and the plant.": "Где между рассуждением и заводом стоит человек или симуляция.",
...
export const industrialZh: TranslationDictionary = {
  ...
  "A verifiable world model for private AI and industrial autonomy.": "面向私有 AI 与工业自主性的可验证世界模型。",
  ...
  "Decision assurance around the digital twins a plant already runs.": "围绕工厂里已经在跑的数字孪生，为决策提供保障。",
  ...
  "GALO AI for Industry — Decision Assurance Around Existing Digital Twins": "GALO AI 面向工业 — 围绕现有数字孪生的决策保障",
  ...
  "GALO keeps state, learned search, local revision and action routes explicit — starting with decision assurance around the digital twins and operational systems a plant already runs. What is proven today is scoped: learning results on synthetic tasks and public benchmarks, published together with the two that did not work. No partner has yet run one on their own data, and nothing here authorises a command to a plant.": "GALO 把状态、学习出来的搜索、局部修正和动作路线都保持显式——起点是围绕工厂里已有的数字孪生和运营系统做决策保障。今天已被证明的是有限范围的：合成任务和公开基准上的学习结果，连同没能奏效的那两项一起公开。还没有任何合作方在自己的数据上跑过，这里的一切也都不授权向工厂下达任何指令。",
...
export const industrialAr: TranslationDictionary = {
  "GALO is a general-purpose architecture for keeping a decision system's state, its permitted actions and the route it took explicit, rather than inside a model nobody can open. The first thing it is sold as is much narrower: decision assurance around the digital twins and operational systems an industrial plant already runs.": "GALO بنية عامّة الغرض تُبقي صريحةً حالةَ نظام القرار وأفعالَه المسموح بها والمسارَ الذي سلكه، بدل إخفائها داخل نموذج لا يستطيع أحد فتحه. أمّا أوّل ما يُباع فأضيق من ذلك بكثير: ضمان القرار حول التوائم الرقمية والأنظمة التشغيلية التي يشغّلها المصنع أصلاً.",
  "It is aimed at work where the expensive failure is not a wrong answer but a wrong answer nobody can trace: industrial operations, regulated processes, long-running automation, and anything a reviewer has to sign. Industry comes first because the cost of ambiguity is already counted there.": "وهو موجَّه إلى عمل يكون فيه الفشل المكلف ليس الجواب الخاطئ، بل الجواب الخاطئ الذي لا يستطيع أحد تتبّعه: التشغيل الصناعي، والعمليات الخاضعة للتنظيم، والأتمتة الطويلة الأمد، وكلّ ما يوقّع عليه مراجع. وتأتي الصناعة أوّلاً لأنّ كلفة الالتباس محسوبة فيها أصلاً.",
  ...
  "No learning in the released kernel; where a prototype does learn, the results are scoped to synthetic tasks and public benchmarks and are published with their negatives.": "لا تعلّم في النواة المُصدَرة؛ وحيث يتعلّم النموذج الأوّلي فعلاً، تبقى النتائج محصورة في مهامّ اصطناعية ومعايير عامّة وتُنشَر مع سلبيّاتها.",
  ...
  "Partly. The Engine and Atlas prototype was measured against preregistered baselines on public benchmarks, and two of those six results were negative. Nothing has been measured against a system in operational use, and no operational gain has been measured anywhere.": "جزئياً. قِيس النموذج الأوّلي للمحرّك وAtlas في مواجهة خطوط أساس مسجَّلة مسبقاً على معايير عامّة، وكانت نتيجتان من ستّ سلبيّتين. ولم يُقَس شيء في مواجهة نظام قيد التشغيل الفعلي، ولم يُقَس أيّ مكسب تشغيلي في أيّ مكان.",
  ...
  "The frozen release accumulates nothing between runs, so two runs on the same input behave identically a year apart. A separate Engine and Atlas prototype does learn, and it is reported apart from this number rather than folded into it.": "لا يراكم الإصدار المجمَّد شيئاً بين الجولات، فتتصرّف جولتان على المُدخل نفسه تصرّفاً متطابقاً بعد عام. أمّا النموذج الأوّلي المنفصل للمحرّك وAtlas فيتعلّم فعلاً، ويُبلَّغ عنه بمعزل عن هذا الرقم لا مطويّاً فيه.",
  "Yes, and it is narrow on purpose: two accepted input patterns, one bounded step per run, four executable action kinds, and no learning in the released kernel. A separate Engine and Atlas prototype does learn, and its results are reported on their own terms.": "نعم، وهو ضيّق عن قصد: نمطا مُدخل مقبولان، وخطوة واحدة محدودة لكلّ جولة، وأربعة أنواع أفعال قابلة للتنفيذ، ولا تعلّم في النواة المُصدَرة. أمّا النموذج الأوّلي المنفصل للمحرّك وAtlas فيتعلّم فعلاً، وتُعرَض نتائجه بشروطها الخاصّة.",
  ...
  "the industrial wedge, in full": "الإسفين الصناعي كاملاً",
  "0% work advantage": "صفر٪ من الوفر في العمل",
  "1.34% fewer candidate checks": "1.34٪ أقلّ في فحوص المرشّحين",
  "49.7% less work than the preregistered global-frequency baseline": "عمل أقلّ بنسبة 49.7٪ من خطّ الأساس المسجَّل مسبقاً القائم على التواتر العامّ",
  ...
  "A far broader product with far more integration behind it. GALO's hypothesis is narrower and more portable: lawful state transitions, an authority boundary the learner cannot cross, and replay that does not depend on the platform being present.": "منتج أوسع بكثير وخلفه تكامل أكبر بكثير. أمّا فرضية GALO فأضيق وأقبل للنقل: انتقالات حالة مشروعة، وحدّ صلاحيات لا يتخطّاه الجزء المتعلِّم، وإعادة تشغيل لا تتوقّف على حضور المنصّة نفسها.",
  "A general architecture and a narrow first product are two different sentences.": "بنية عامّة ومنتج أول ضيّق: جملتان مختلفتان.",
  "A general-purpose architecture is a design intention. General intelligence would need broad perception, transfer, planning and grounding well beyond any evidence here.": "البنية العامّة الغرض نيّة تصميمية. أمّا الذكاء العام فيتطلّب إدراكاً واسعاً ونقلاً وتخطيطاً وارتباطاً بالعالم يتجاوز بكثير أي دليل هنا.",
  ...
  "A post-reveal oracle, never promotable.": "عرّاف بعد الكشف، لا يُرقّى أبداً.",
  ...
  "A single arm proves nothing: any improvement can be explained by a weaker comparator, a leak, or the order of the data. Seven arms remove those explanations one at a time, and the promotion gates are written down before the sealed set is opened.": "ذراع واحدة لا تُثبت شيئاً: يمكن تفسير أي تحسّن بمقارنٍ أضعف، أو تسرّب، أو ترتيب البيانات. سبع أذرع تُزيل هذه التفسيرات واحداً واحداً، وشروط الترقية تُكتب قبل فتح المجموعة المختومة.",
  ...
  "A stronger equal-information comparator was not beaten. This is not universal superiority.": "لم يُتجاوَز مقارِنٌ أقوى متكافئ في المعلومات. وهذا ليس تفوّقاً شاملاً.",
  "A terminal, safety and actual-work ledger.": "سجلّ للنتيجة النهائية والسلامة والعمل الفعلي.",
  "A verifiable world model for private AI and industrial autonomy.": "نموذج عالم قابل للتحقّق للذكاء الاصطناعي الخاص والاستقلالية الصناعية.",
  ...
  "A0 must beat or materially complement A2 on a preregistered endpoint.": "على A0 أن تتفوّق على A2 أو تكمّلها جوهرياً عند نقطة نهاية مسجَّلة مسبقاً.",
  "AED 150k–300k": "150–300 ألف درهم",
  "AED 350k–750k": "350–750 ألف درهم",
  "AED 600k–1.8m per site per year": "600 ألف – 1.8 مليون درهم لكل موقع سنوياً",
  "Above the systems that run the plant, and never inside them.": "فوق الأنظمة التي تُدير المصنع، ولا داخلها أبداً.",
  "Advisory": "الوضع الاستشاري",
  "Advisory and simulation first": "الاستشارة والمحاكاة أوّلاً",
  ...
  "An operational Atlas effect on a public benchmark, measured against a baseline fixed in advance.": "أثر تشغيليّ لـAtlas على معيار عامّ، مقيسٌ إلى خطّ أساس ثُبِّت سلفاً.",
  ...
  "Candidate checks are not full cognitive work, and this is not a production improvement.": "فحوص المرشّحين ليست العمل الإدراكي الكامل، وهذا ليس تحسّناً في التشغيل الفعلي.",
  ...
  "Collapsing them is the quickest way to say something untrue in either direction — either the product sounds like general intelligence, or the architecture sounds like a maintenance tool. They are stated separately here and everywhere else on the site.": "خلطهما أسرع طريق إلى قول ما ليس صحيحاً في أي من الاتجاهين: فإمّا أن يبدو المنتج ذكاءً عامّاً، وإمّا أن تبدو البنية أداة صيانة. وهما مذكوران منفصلين هنا وفي كل موضع من الموقع.",
  ...
  "Decision assurance around the digital twins a plant already runs.": "ضمان القرار حول التوائم الرقمية التي يشغّلها المصنع بالفعل.",
  "Delay already costs money": "التأخير يكلّف مالاً بالفعل",
  "Design-partner planning hypotheses · not current prices": "فرضيات تخطيطية لشريك تصميم · وليست أسعاراً سارية",
  "Digital twin · SCADA · historian · MES · ERP · CMMS · manuals · sensors": "التوأم الرقمي · SCADA · مؤرشِف البيانات · MES · ERP · CMMS · الأدلّة · الحسّاسات",
  ...
  "Drop any one of these and the number above becomes unreadable rather than merely weaker. They are listed so a reviewer can check which one they think we got wrong.": "أسقِط واحداً منها فيصير الرقم أعلاه غير قابل للقراءة لا مجرّد أضعف. وهي مسرودة ليتمكّن المراجع من تحديد أيّها يرى أنّنا أخطأنا فيه.",
  "Duration": "المدّة",
  "Each step names the partner system it reads, the artefact GALO produces, and the control that stops the step from being gamed. The controls are the point: without them a work-reduction number means nothing.": "تسمّي كل خطوة نظام الشريك الذي تقرأ منه، والمصنوع الذي ينتجه GALO، والضابط الذي يمنع التلاعب بها. والضوابط هي جوهر الأمر: من دونها لا يعني رقم خفض العمل شيئاً.",
  ...
  "Every result so far is on synthetic tasks or public benchmarks. No partner has run one of these on their own data with their own evaluator, and that is the next required step.": "كل نتيجة حتى الآن على مهامّ اصطناعية أو معايير عامّة. ولم يُجرِ أي شريك واحدة منها على بياناته وبجهة تقييمه، وهذه هي الخطوة التالية اللازمة.",
  "Exact equality for any arm that may be promoted.": "تساوٍ تامّ لأي ذراع قابلة للترقية.",
  "Existing PLC · robot controller · certified safety interlocks": "وحدات PLC القائمة · متحكّم الروبوت · مصاريع الأمان المعتمَدة",
  ...
  "Faster diagnosis and cheaper re-verification only pay where the delay is measured.": "التشخيص الأسرع وإعادة التحقّق الأرخص لا يُجديان إلّا حيث يكون التأخير مقيساً.",
  "Five rungs, and the evidence that would open each one.": "خمس درجات، والدليل الذي يفتح كلّاً منها.",
  ...
  "GALO artefact": "مُخرَج GALO",
  "GALO does not replace a digital twin, a SCADA system, a PLC, a robot controller or a safety interlock, and no proposed version writes to any of them directly. It reads what they publish and hands its conclusion to a person, a simulation or an approval gateway.": "لا يحلّ GALO محلّ التوأم الرقمي ولا SCADA ولا PLC ولا متحكّم الروبوت ولا مصراع الأمان، ولا تكتب أي نسخة مقترحة إليها مباشرةً. إنّه يقرأ ما تنشره ويسلّم خلاصته إلى إنسان أو محاكاة أو بوّابة موافقة.",
  ...
  "GALO is designed to sit above existing digital twins, SCADA systems, PLCs, robot controllers and safety interlocks, and replaces none of them.": "صُمّم GALO ليقف فوق التوائم الرقمية وأنظمة SCADA ووحدات PLC ومتحكّمات الروبوتات ومصاريع الأمان القائمة، ولا يحلّ محلّ أيٍّ منها.",
  ...
  "GALO keeps state, learned search, local revision and action routes explicit — starting with decision assurance around the digital twins and operational systems a plant already runs. What is proven today is scoped: learning results on synthetic tasks and public benchmarks, published together with the two that did not work. No partner has yet run one on their own data, and nothing here authorises a command to a plant.": "يُبقي GALO الحالةَ والبحثَ المتعلَّم والمراجعةَ الموضعية ومسارات الفعل صريحةً — بدءاً بضمان القرار حول التوائم الرقمية والأنظمة التشغيلية التي يشغّلها المصنع أصلاً. وما ثبت اليوم محدود النطاق: نتائج تعلّم على مهامّ اصطناعية ومعايير عامّة، منشورة مع النتيجتين اللتين لم تنجحا. ولم يُجرِ أي شريك واحدة منها على بياناته، ولا شيء هنا يأذن بأمرٍ إلى مصنع.",
  "GENERAL-PURPOSE ARCHITECTURE · INDUSTRIAL DECISION ASSURANCE FIRST": "بنية عامّة الغرض · ضمان القرار الصناعي أوّلاً",
  ...
  "If A0 does not beat A1 under the frozen contract, or if there is an oracle leak, a frozen write, candidate drift or a false accept, the result stays NOT_SUPPORTED on that scope. The protocol is not changed after the sealed set has been inspected.": "إذا لم يتفوّق A0 على A1 تحت العقد المجمَّد، أو ظهر تسريب من العرّاف أو كتابة في المجمَّد أو انزياح في المرشّحين أو قبول خاطئ، تبقى النتيجة NOT_SUPPORTED على ذلك النطاق. ولا يُغيَّر البروتوكول بعد فحص المجموعة المختومة.",
  ...
  "Industry is chosen because the cost of ambiguity, downtime and an unsafe action is already measured there. A narrow market with measurable stakes falsifies an architecture faster than a broad one without them.": "اختيرت الصناعة لأنّ كلفة الالتباس والتوقّف والفعل غير الآمن محسوبة فيها أصلاً. وسوق ضيّقة ذات رهان قابل للقياس تُكذِّب بنيةً أسرع من سوق واسعة بلا رهان.",
  "Internal work-unit accounting is not a speedup, a causal outcome, customer value or an external gain result. No partner has run an evaluation on their own data with their own evaluator.": "حساب وحدات العمل داخلياً ليس تسريعاً ولا نتيجة سببية ولا قيمةً للعميل ولا مكسباً خارجياً. ولم يُجرِ أي شريك تقييماً على بياناته بمُقيِّمه الخاصّ.",
  ...
  "It allows an advisory-first deployment that is safe by construction.": "تتيح نشراً استشارياً أوّلاً، آمناً بحكم البناء.",
  ...
  "Less actual work, measured against the same mechanism rather than a weaker one.": "عمل فعليّ أقلّ، مقيساً في مواجهة الآلية نفسها لا في مواجهة آلية أضعف.",
  ...
  "Models fitted to historical operating data, producing an alert, a score or a forecast.": "نماذج مُلائَمة لبيانات تشغيل تاريخية، تُنتج تنبيهاً أو درجةً أو تنبّؤاً.",
  "Most plants are not suitable, and saying so early is part of the product.": "معظم المصانع غير مناسبة، وقول ذلك مبكّراً جزء من المنتج.",
  ...
  "No historian or SCADA, no asset hierarchy, no maintenance record, no versioned procedures.": "لا مؤرِّخ بيانات ولا SCADA، ولا تسلسل هرمي للأصول، ولا سجلّ صيانة، ولا إجراءات ذات إصدارات.",
  ...
  "No oracle leak: the evaluator outcome is signed outside the engine.": "لا تسريب من العرّاف: نتيجة المُقيِّم موقَّعة خارج المحرّك.",
  ...
  "Nothing here authorises a command to a plant, a controller or a robot. The roadmap is advisory first, then simulation, and every rung above that is gated.": "لا شيء هنا يأذن بأمرٍ إلى مصنع أو متحكّم أو روبوت. خارطة الطريق استشارية أوّلاً، ثمّ محاكاة، وكلّ درجة فوق ذلك محكومة ببوّابة.",
  ...
  "Operational data already exists": "بيانات التشغيل موجودة أصلاً",
  ...
  "Request a bounded industrial evaluation": "اطلب تقييماً صناعياً محدود النطاق",
  ...
  "Systems that already exist and stay in place. GALO reads them and replaces none of them.": "أنظمة موجودة أصلاً وتبقى في مكانها. يقرؤها GALO ولا يحلّ محلّ أيّ منها.",
  ...
  "That the L1–L7 tower beats a matched alternative is a research hypothesis. It is not offered as a reason to invest.": "أنّ برج L1–L7 يتفوّق على بديل مكافئ فرضيةٌ بحثية. ولا تُقدَّم سبباً للاستثمار.",
  "That the heldout effect could not be computed on this task at all.": "أنّ الأثر على المجموعة المحجوزة لم يكن قابلاً للحساب على هذه المهمّة أصلاً.",
  "The DEV and SEALED roots stay frozen.": "يبقى جذرا DEV وSEALED مجمَّدَين.",
  "The R5B6A1_3 release performs no policy update at all. The V65–V67 Engine and Atlas line is a separate prototype with its own scoped learning evidence, published below with its negatives.": "لا يُجري إصدار R5B6A1_3 أيّ تحديث للسياسة إطلاقاً. أمّا خطّ المحرّك وAtlas V65–V67 فهو نموذج أوّلي منفصل بأدلّة تعلّم محدودة النطاق خاصّة به، منشورة أدناه مع نتائجها السلبية.",
  "The action space the partner has approved.": "فضاء الأفعال الذي أقرّه الشريك.",
  "The alert can be checked against what happened next, and the model against the operating window it was trained on.": "يمكن مراجعة التنبيه في مواجهة ما حدث لاحقاً، والنموذج في مواجهة نافذة التشغيل التي دُرِّب عليها.",
  "The architecture is meant to be general. The first product is deliberately not: one industrial workflow, read only, advisory, with a frozen baseline and a decision package somebody else can replay. Industry is where the cost of ambiguity is already counted, which is why an architecture is worth testing there first.": "البنية مقصودة عامّة. أمّا المنتج الأوّل فليس كذلك عن قصد: سير عمل صناعي واحد، بالقراءة فقط، استشاري، مع خطّ أساس مجمَّد وحزمة قرار يستطيع غيرنا إعادة تشغيلها. وفي الصناعة تُحسَب كلفة الالتباس أصلاً، ولذلك تستحقّ البنية أن تُختبَر هناك أوّلاً.",
  ...
  "The success condition is written after the results are seen, the data used is ours rather than a partner's, or the run touches anything beyond read access.": "كُتب شرط النجاح بعد رؤية النتائج، أو استُعملت بياناتنا بدل بيانات الشريك، أو مسّ التشغيلُ شيئاً خارج صلاحية القراءة.",
  "The surface GALO is designed to read, not a thing to displace. A twin says what and where; the question GALO takes on is which explanations are still open, which check separates them, and what may lawfully be done next.": "السطح الذي صُمِّم GALO لقراءته، لا شيء يُزاح. التوأم يقول ما الذي حدث وأين؛ والسؤال الذي يتولّاه GALO هو أيّ التفسيرات ما تزال مفتوحة، وأيّ فحص يفصل بينها، وما الذي يجوز فعله بعد ذلك.",
  ...
  "These are the numbers we would open a conversation with. They are not a price list, not a signed pipeline and not revenue — no partner has agreed to any of them, because there is no partner yet.": "هذه الأرقام التي نفتح بها محادثة. ليست قائمة أسعار ولا مسار مبيعات موقَّعاً ولا إيراداً — لم يوافق عليها أيّ شريك، لأنّه لا شريك بعد.",
  "This is separate from the frozen release above, which still performs no learning at all. Alongside it there is a receipt-native Engine and Atlas prototype with scoped learning results on synthetic tasks and public benchmarks. Both statements are true at once, and neither is allowed to imply the other. The negatives are in the same table, in the same style.": "هذا منفصل عن الإصدار المجمَّد أعلاه، الذي ما يزال لا يتعلّم شيئاً البتّة. وإلى جانبه نموذج أوّلي لمحرّك وAtlas أصليَّي الإيصالات، بنتائج تعلّم محدودة النطاق على مهامّ اصطناعية ومعايير عامّة. العبارتان صحيحتان معاً، ولا يُسمح لأيّ منهما بأن توحي بالأخرى. والنتائج السلبية في الجدول نفسه وبالأسلوب نفسه.",
  ...
  "UMLS 49.7% less work against a preregistered baseline; WN18RR 7.17%, CI95 5.82-8.55%; JF17K-3 1.34% fewer candidate checks; Kinship 0% work advantage; Nations not identifiable.": "UMLS: عمل أقلّ بنسبة 49.7٪ في مواجهة خطّ أساس مسجَّل مسبقاً؛ WN18RR: 7.17٪ بفاصل ثقة 95٪ من 5.82 إلى 8.55٪؛ JF17K-3: فحوص مرشّحين أقلّ بنسبة 1.34٪؛ Kinship: صفر٪ من الوفر؛ Nations: غير قابل للتمييز.",
  "Untouched. No current or proposed path writes to them directly.": "لم تُمَسّ. ولا يكتب فيها مباشرةً أيّ مسار حالي أو مقترَح.",
  "V65 preregistered synthetic run": "جولة V65 الاصطناعية المسجَّلة مسبقاً",
  ...
  "Where GALO sits, and what it never touches": "أين يقف GALO، وما الذي لا يمسّه أبداً",
