...
export const industrialAr: TranslationDictionary = {
  "GALO is a general-purpose architecture for keeping a decision system's state, its permitted actions and the route it took explicit, rather than inside a model nobody can open. The first thing it is sold as is much narrower: decision assurance around the digital twins and operational systems an industrial plant already runs.": "GALO بنية عامّة الغرض تُبقي صريحةً حالةَ نظام القرار وأفعالَه المسموح بها والمسارَ الذي سلكه، بدل إخفائها داخل نموذج لا يستطيع أحد فتحه. أمّا أوّل ما يُباع فأضيق من ذلك بكثير: ضمان القرار حول التوائم الرقمية والأنظمة التشغيلية التي يشغّلها المصنع أصلًا.",
  "It is aimed at work where the expensive failure is not a wrong answer but a wrong answer nobody can trace: industrial operations, regulated processes, long-running automation, and anything a reviewer has to sign. Industry comes first because the cost of ambiguity is already counted there.": "وهو موجَّه إلى عمل يكون فيه الفشل المكلف ليس الجواب الخاطئ، بل الجواب الخاطئ الذي لا يستطيع أحد تتبّعه: التشغيل الصناعي، والعمليات الخاضعة للتنظيم، والأتمتة الطويلة الأمد، وكلّ ما يوقّع عليه مراجع. وتأتي الصناعة أوّلًا لأنّ كلفة الالتباس محسوبة فيها أصلًا.",
  ...
  "A post-reveal oracle, never promotable.": "عرّاف بعد الكشف، لا يُرقّى أبدًا.",
  ...
  "Collapsing them is the quickest way to say something untrue in either direction — either the product sounds like general intelligence, or the architecture sounds like a maintenance tool. They are stated separately here and everywhere else on the site.": "خلطهما أسرع طريق إلى قول ما ليس صحيحًا في أي من الاتجاهين: فإمّا أن يبدو المنتج ذكاءً عامًّا، وإمّا أن تبدو البنية أداة صيانة. وهما مذكوران منفصلين هنا وفي كل موضع من الموقع.",
  ...
  "Drop any one of these and the number above becomes unreadable rather than merely weaker. They are listed so a reviewer can check which one they think we got wrong.": "أسقِط واحدًا منها فيصير الرقم أعلاه غير قابل للقراءة لا مجرّد أضعف. وهي مسرودة ليتمكّن المراجع من تحديد أيّها يرى أنّنا أخطأنا فيه.",
  "Duration": "المدّة",
  "Each step names the partner system it reads, the artefact GALO produces, and the control that stops the step from being gamed. The controls are the point: without them a work-reduction number means nothing.": "تسمّي كل خطوة نظام الشريك الذي تقرأ منه، والمصنوع الذي ينتجه GALO، والضابط الذي يمنع التلاعب بها. والضوابط هي جوهر الأمر: من دونها لا يعني رقم خفض العمل شيئًا.",
  ...
  "Five rungs, and the evidence that would open each one.": "خمس درجات، والدليل الذي يفتح كلًّا منها.",
  ...
  "GALO keeps state, learned search, local revision and action routes explicit — starting with decision assurance around the digital twins and operational systems a plant already runs. What is proven today is scoped: learning results on synthetic tasks and public benchmarks, published together with the two that did not work. No partner has yet run one on their own data, and nothing here authorises a command to a plant.": "يُبقي GALO الحالةَ والبحثَ المتعلَّم والمراجعةَ الموضعية ومسارات الفعل صريحةً — بدءًا من جعل القرار قابلًا للدفاع عنه حيث تعمل في المصنع توائمُه الرقمية وأنظمتُه التشغيلية أصلًا. وما ثبت اليوم محدود النطاق: نتائج تعلّم على مهامّ اصطناعية ومعايير عامّة، منشورة مع النتيجتين اللتين لم تنجحا. ولم يُجرِ أي شريك واحدة منها على بياناته، ولا شيء هنا يأذن بأمرٍ إلى مصنع.",
  ...
  "These are the numbers we would open a conversation with. They are not a price list, not a signed pipeline and not revenue — no partner has agreed to any of them, because there is no partner yet.": "هذه الأرقام التي نفتح بها محادثة. ليست قائمة أسعار ولا مسار مبيعات موقَّعًا ولا إيرادًا — لم يوافق عليها أيّ شريك، لأنّه لا شريك بعد.",
  "This is separate from the frozen release above, which still performs no learning at all. Alongside it there is a receipt-native Engine and Atlas prototype with scoped learning results on synthetic tasks and public benchmarks. Both statements are true at once, and neither is allowed to imply the other. The negatives are in the same table, in the same style.": "هذا منفصل عن الإصدار المجمَّد أعلاه، الذي ما يزال لا يتعلّم شيئًا البتّة. وإلى جانبه نموذج أوّلي لمحرّك وAtlas أصليَّي الإيصالات، بنتائج تعلّم محدودة النطاق على مهامّ اصطناعية ومعايير عامّة. العبارتان صحيحتان معًا، ولا يُسمح لأيّ منهما بأن توحي بالأخرى. والنتائج السلبية في الجدول نفسه وبالأسلوب نفسه.",
