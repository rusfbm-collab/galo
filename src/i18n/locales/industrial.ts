...
export const industrialRu: TranslationDictionary = {
  ...
  "Decision assurance around the digital twins a plant already runs.": "Решение, которое можно отстоять, — рядом с цифровыми двойниками, которые на заводе уже работают.",
