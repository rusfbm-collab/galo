...
export const tableSpaceRu: TranslationDictionary = {
  "PLUS and STAR at L{level} · {pairs} addresses each": "PLUS и STAR на L{level} · по {pairs} адресов в каждой",
  "Q_{level} · {poles} positions": "Q_{level} · {poles} позиции",
  "k role slots": "k ролевых слотов",
  "{cells} typed cells": "{cells} типизированных клеток",
  ...
  "Bars follow digit count, not value.": "Длина столбцов — по числу цифр, а не по величине.",
  CARRIER: "НОСИТЕЛЬ",
  DECLARED: "ОБЪЯВЛЕНО",
  "Declare how many places the scene has": "Объявить, сколько у сцены мест",
  ...
  "HOW A FRAME IS MADE OUT OF THE TABLES": "КАК ФРЕЙМ ПОЛУЧАЕТСЯ ИЗ ТАБЛИЦ",
  "HOW MANY TABLES THERE ARE, AND HOW MANY ARE DECLARED": "СКОЛЬКО ТАБЛИЦ СУЩЕСТВУЕТ И СКОЛЬКО ОБЪЯВЛЕНО",
  ...
  "POSSIBLE TABLES": "ВОЗМОЖНЫЕ ТАБЛИЦЫ",
  ...
  "Pick a level": "Выбрать уровень",
  "Polarity is local to this frame.": "Полярность локальна этому фрейму.",
  "ROLE SLOTS": "РОЛЕВЫЕ СЛОТЫ",
  "Read each cell with its roles": "Прочитать каждую клетку с её ролями",
  ...
  "THE SAME TWO TABLES": "ТЕ ЖЕ ДВЕ ТАБЛИЦЫ",
  "Take the two frozen laws at it": "Взять два его замороженных закона",
  ...
  "is the arity": "— это арность",
  "is the level": "— это уровень",
  "is the route length": "— это длина маршрута",
};

export const tableSpaceZh: TranslationDictionary = {
  "PLUS and STAR at L{level} · {pairs} addresses each": "L{level} 上的 PLUS 与 STAR · 各 {pairs} 个地址",
  "Q_{level} · {poles} positions": "Q_{level} · {poles} 个位置",
  "k role slots": "k 个角色槽位",
  "{cells} typed cells": "{cells} 个带类型的格子",
  "A frame is the two tables, plus three declarations about how to read them.":
    "一个框架就是那两张表，外加三条关于「怎么读它们」的声明。",
  "A program is not written in the open. It is written inside a frame: a local scene that has already declared which level it works at, which two tables it reads, and how many places it has. The frame is where the tables stop being arithmetic and start being a thing you can state a relation in.":
    "程序不是写在空地上的。它写在一个框架里面：这个局部场景已经声明了自己在哪个层级上工作、读哪两张表、有几个位置。正是在框架里，那两张表不再只是算术，而成了可以在其中陈述一条关系的东西。",
  "Bars follow digit count, not value.": "条形的长度按位数来，不按数值来。",
  CARRIER: "载体",
  DECLARED: "已声明",
  "Declare how many places the scene has": "声明这个场景有几个位置",
  "Each of the n × n cells may hold any of the n positions, so a level of size n has n^(n²) possible tables. The bars count digits rather than values, because the growth is the subject: by L5 the space is past anything anyone could enumerate, and it keeps going.":
    "n × n 张格子里的每一格都可以放 n 个位置中的任意一个，所以一个大小为 n 的层级有 n^(n²) 张可能的表。条形数的是位数而不是数值，因为这里要看的是增长：到了 L5，这个空间已经超出任何人能枚举的范围，而且还在继续涨。",
  "Four declarations turning two Cayley tables into one frame": "四条声明，把两张凯莱表变成一个框架",
  "Four numbered steps down the left — choose a level, take its two frozen laws, read each cell with its roles, declare how many places the scene has — feeding into a panel on the right. The panel shows the carrier positions, the two tables drawn as grids, and the empty role slots that make up one frame.":
    "左侧四个编号的步骤——选一个层级、取这个层级上那两条冻结的法则、按角色去读每一格、声明这个场景有几个位置——汇入右侧的一块面板。面板里画着载体的各个位置、用网格画出的那两张表，以及构成一个框架的那些空的角色槽位。",
  "HOW A FRAME IS MADE OUT OF THE TABLES": "框架是怎么从表里做出来的",
  "HOW MANY TABLES THERE ARE, AND HOW MANY ARE DECLARED": "一共有多少张表，声明了多少张",
  "Nothing here says the two declared laws are the best two. It says what they were declared out of.":
  ...
  "POSSIBLE TABLES": "可能的表",
  "Past 10^41 to choose from at L7. Two are declared, and then frozen.":
    "在 L7 可挑的超过 10^41 张。被声明的是两张——然后冻结。",
  "Pick a level": "选一个层级",
  "Polarity is local to this frame.": "极性只属于这个框架。",
  "ROLE SLOTS": "角色槽位",
  "Read each cell with its roles": "按角色去读每一格",
  "Seven horizontal bars, one per level, whose lengths follow the number of digits in the count of possible tables. Level 1 has one table, level 3 has 19,683, level 7 has more than 10 to the 41st. A short bar underneath marks the fourteen tables GALO actually declares.":
    "七道横条，每个层级一道，长度跟着「可能的表」这个数的位数走。层级 1 只有一张表，层级 3 有 19,683 张，层级 7 超过 10 的 41 次方。下面一道短条标出 GALO 实际声明的那十四张表。",
  "THE SAME TWO TABLES": "同样的那两张表",
  "Take the two frozen laws at it": "取这个层级上那两条冻结的法则",
  "The number of possible tables at each level, against the two that are declared":
  ...
  "is the arity": "是元数",
  "is the level": "是层级",
  "is the route length": "是路线长度",
};

export const tableSpaceAr: TranslationDictionary = {
  "PLUS and STAR at L{level} · {pairs} addresses each": "PLUS وSTAR في L{level} · {pairs} عنوانًا في كلٍّ منهما",
  "Q_{level} · {poles} positions": "Q_{level} · {poles} مواضع",
  "k role slots": "k من خانات الأدوار",
  "{cells} typed cells": "{cells} خلية محددة النوع",
  "A frame is the two tables, plus three declarations about how to read them.":
  ...
  "Bars follow digit count, not value.": "أطوال الأعمدة بعدد الأرقام لا بالقيمة.",
  CARRIER: "الحامل",
  DECLARED: "المعلن",
  "Declare how many places the scene has": "أعلِن كم موضعًا للمشهد",
  "Each of the n × n cells may hold any of the n positions, so a level of size n has n^(n²) possible tables. The bars count digits rather than values, because the growth is the subject: by L5 the space is past anything anyone could enumerate, and it keeps going.":
  ...
  "Four declarations turning two Cayley tables into one frame": "أربعة إعلانات تحوّل جدولَي كايلي إلى إطارٍ واحد",
  "Four numbered steps down the left — choose a level, take its two frozen laws, read each cell with its roles, declare how many places the scene has — feeding into a panel on the right. The panel shows the carrier positions, the two tables drawn as grids, and the empty role slots that make up one frame.":
  ...
  "HOW A FRAME IS MADE OUT OF THE TABLES": "كيف يُصنع الإطار من الجداول",
  "HOW MANY TABLES THERE ARE, AND HOW MANY ARE DECLARED": "كم جدولًا يوجد، وكم منها معلن",
  "Nothing here says the two declared laws are the best two. It says what they were declared out of.":
  ...
  "POSSIBLE TABLES": "الجداول الممكنة",
  "Past 10^41 to choose from at L7. Two are declared, and then frozen.":
    "في L7 يوجد أكثر من 10^41 للاختيار منه. المعلن اثنان — ثم يُجمَّدان.",
  "Pick a level": "اختر مستوى",
  "Polarity is local to this frame.": "القطبية محلية لهذا الإطار.",
  "ROLE SLOTS": "خانات الأدوار",
  "Read each cell with its roles": "اقرأ كل خلية بأدوارها",
  "Seven horizontal bars, one per level, whose lengths follow the number of digits in the count of possible tables. Level 1 has one table, level 3 has 19,683, level 7 has more than 10 to the 41st. A short bar underneath marks the fourteen tables GALO actually declares.":
  ...
  "THE SAME TWO TABLES": "الجدولان نفسهما",
  "Take the two frozen laws at it": "خذ قانونَي هذا المستوى المجمَّدَين",
  "The number of possible tables at each level, against the two that are declared":
  ...
  "is the arity": "هو الأرية",
  "is the level": "هو المستوى",
  "is the route length": "هو طول المسار",
};
