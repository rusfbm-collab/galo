...
export const theoryZh: TranslationDictionary = {
  "2 local states": "2 个局部状态",
  "3 local states": "3 个局部状态",
  "4 local states": "4 个局部状态",
  "5 local states": "5 个局部状态",
  "6 local states": "6 个局部状态",
  "7 local states": "7 个局部状态",
  "A formal target is not yet world meaning, a useful action, a learned policy, or General AI.":
    "形式化目标尚不等同于世界语义、有用行动、已学习策略或通用人工智能。",
  "A level L_n declares exactly n local labels P0 through P_(n−1).":
    "层级 L_n 恰好声明 n 个局部标签，从 P0 到 P_(n−1)。",
  "Apply one frozen law": "应用一个冻结运算律",
  "Build GALO from one three-state example before opening the academic reference.":
    "先通过一个三状态示例建立 GALO 的直观模型，再进入学术参考章节。",
  "ILLUSTRATIVE TARGET RESOLUTION LADDER": "说明性目标分辨率阶梯",
  "Illustrative target resolution ladder": "说明性目标分辨率阶梯",
  "LEFT and RIGHT record how source and active are placed on the table axes.":
    "LEFT 与 RIGHT 记录源状态和活动极如何放置在表格两轴上。",
  "More poles are not automatically better. Current V4 does not prove observation-conditioned level selection.":
    "更多的极并不自动意味着更好。当前 V4 尚未证明能够依据观测选择层级。",
  "NEW TO THE MATHEMATICS?": "初次接触这套数学？",
  "Name the finite states": "为有限状态命名",
  "Open the guided theory": "打开引导式理论章节",
  "PLUS performs cyclic addition; STAR adds a precise raw-left P0 reset clause.":
    "PLUS 执行循环加法；STAR 在此基础上加入精确的原始左侧 P0 重置分支。",
  "Preserve the input roles": "保留输入角色",
  "Stop at the evidence boundary": "在证据边界处停止",
  "The beginner chapter explains every symbol, reconstructs transitions independently from tables and formulas, and keeps the formal model separate from the current runtime and target learning architecture.":
    "入门章节解释每个符号，分别从表格与公式独立重建转换，并将形式化模型、当前运行时和目标学习架构严格分开。",
  "The target architecture proposes choosing only the level needed to preserve a task-relevant distinction.":
    "目标架构提出：只选择足以保留任务相关差异的层级。",
  "Understand GALO step by step": "逐步理解 GALO",
  Home: "首页",
  "Theory · start here": "理论入门 · 从这里开始",
  "GALO Theory for Beginners — From States to Verified Execution": "GALO 理论入门 — 从状态到可验证执行",
  "Understand GALO step by step: finite states, PLUS and STAR, typed transitions, 560 coordinates, programs, symmetries, level maps, runtime scope, and evidence boundaries.":
    "循序理解 GALO：有限状态、PLUS 与 STAR、类型化转换、560 个坐标、程序、对称性、层级间映射、运行时范围以及证据边界。",

  "The idea in one sentence": "一句话理解核心思想",
  "States, levels, and wraparound": "状态、层级与循环回绕",
  "PLUS and STAR without jargon": "不用术语理解 PLUS 与 STAR",
  "Why P0 has two one-sided roles": "为什么 P0 具有两个单侧角色",
  "Source, active, LEFT, and RIGHT": "源状态、活动极、LEFT 与 RIGHT",
  "Guided transition laboratory": "引导式状态转换实验室",
  "Where the number 560 comes from": "数字 560 从何而来",
  "From cells to bracketed programs": "从单元格到带括号的程序",
  "Symmetry in plain language": "用通俗语言理解对称性",
  "Maps between levels": "层级之间的映射",
  "How the mathematics fits the architecture": "数学结构如何嵌入整体架构",
  "How to read GALO evidence": "如何阅读 GALO 证据",
  "Plain-language glossary": "通俗术语表",
  ...
  "typed programs": "类型化程序",
  "receipts and boundaries": "回执与边界",
  "Begin with the mental model": "先建立直观模型",
  "Beginner theory chapter navigation": "理论入门章节导航",
  "Build the theory in this order": "请按此顺序建立理论",

  "THE IDEA IN ONE SENTENCE": "一句话理解核心思想",
  "GALO makes a finite reasoning state and its permitted changes explicit enough to calculate, inspect, and replay.":
    "GALO 将有限推理状态及其允许发生的变化显式化，使其可以被计算、检查和重放。",
  "The formal kernel is an exact alphabet for state transitions. It is not by itself a language model, a trained memory, a proof of intelligence, or a certificate that a statement about the world is true.":
    "形式化内核是一套精确的状态转换字母表。它本身既不是语言模型，也不是已训练记忆；它不能证明系统具有智能，也不能证明某个关于现实世界的陈述为真。",
  "Make the possible states explicit": "显式列出所有可能状态",
  "Instead of hiding every distinction in an opaque vector, begin with a declared finite set of local state labels.":
    "不要把所有差异都隐藏在不透明的向量中，而应从一个明确声明的有限局部状态标签集合开始。",
  "Make every transition addressable": "让每一次转换都有明确地址",
  "A level, action family, source, and active pole identify one exact transition coordinate.":
    "层级、动作族、源状态和活动极共同确定一个精确的转换坐标。",
  "Separate calculation from interpretation": "把计算与解释分开",
  "The finite law computes a target. Meaning, authority, evidence, and real-world action require additional contracts.":
    "有限运算律只负责计算目标状态。语义、权限、证据以及现实世界中的行动还需要额外契约。",
  "Running example": "贯穿全章的示例",
  "Imagine a dial with exactly three labelled positions. P0, P1, and P2 are names for those positions. The labels may later receive domain meaning, but the mathematics initially knows only the finite positions and their transition rules.":
    "设想一个恰有三个带标签位置的刻度盘。P0、P1 和 P2 只是这些位置的名称。之后可以为标签赋予具体领域含义，但数学在起点只知道这些有限位置及其转换规则。",

  "STATES, LEVELS, AND WRAPAROUND": "状态、层级与循环回绕",
  "A level says how many local distinctions are available.": "层级说明当前可以区分多少个局部状态。",
  "L_n uses n labelled poles. For calculation, P_i corresponds to the remainder i modulo n. This correspondence supplies exact arithmetic without claiming that a pole has one universal meaning.":
    "L_n 使用 n 个带标签的极。计算时，P_i 对应模 n 的余数类 i。这一对应关系提供精确算术，但并不声称某个极具有唯一且普遍的语义。",
  "The L3 dial": "L3 刻度盘",
  "Three-state cyclic dial": "三状态循环刻度盘",
  "After P2, one more cyclic step returns to P0. That is all wraparound means here.":
    "到达 P2 后再前进一步就回到 P0；这就是此处“循环回绕”的全部含义。",
  "Three different object classes": "三类不同对象",
  Label: "标签",
  "Calculation index": "计算指标",
  "Domain meaning": "领域含义",
  "Not supplied by the algebra; it must come from a separate typed map and evidence.":
    "代数本身不提供领域含义；它必须由独立的类型化映射和证据给出。",
  "Analogy boundary:": "类比边界：",
  "The dial explains modular arithmetic, not the semantics of GALO. P0 is not automatically false, empty, bad, safe, or authorized; P1 and P2 are not quantities unless a separate model declares them to be.":
    "刻度盘只用于解释模运算，而不解释 GALO 的语义。P0 并不会自动表示“假”“空”“坏”“安全”或“已授权”；除非另一个模型作出明确声明，P1 和 P2 也不是数值量。",

  "PLUS AND STAR WITHOUT JARGON": "不用术语理解 PLUS 与 STAR",
  "PLUS always moves around the dial. STAR first asks one exact reset question.":
    "PLUS 始终沿刻度盘循环移动；STAR 则先检查一个精确的重置条件。",
  "Both laws accept two poles and return one pole at the same level. Their complete behaviour can be reconstructed either from the formula or from the Cayley table.":
    "两个运算律都接收两个极，并在同一层级返回一个极。它们的全部行为既可以由公式重建，也可以由凯莱表重建。",
  "PLUS · cyclic addition": "PLUS · 循环加法",
  "Add the indices, then wrap around.": "先把指标相加，再按模数回绕。",
  "At L3, moving two steps from index 1 lands on index 0 after wraparound.":
    "在 L3 中，从指标 1 前进两步，经回绕后到达指标 0。",
  "STAR · left-reset-sensitive addition": "STAR · 对左侧重置敏感的加法",
  "Inspect the raw-left pole first.": "先检查原始左操作数中的极。",
  "The reset test examines only the raw-left input. A right P0 does not trigger it.":
    "重置判定只检查原始左输入；位于右侧的 P0 不会触发重置。",
  "Complete L3 PLUS table": "完整的 L3 PLUS 表",
  "Complete L3 STAR table": "完整的 L3 STAR 表",
  "Consistency check: every displayed table cell is obtained by substituting its row and column indices into the displayed formula. The two channels agree for all nine L3 input pairs.":
    "一致性检查：每个已显示单元格都由其行、列指标代入所示公式得到。对于 L3 的全部九个输入对，公式通道与表格通道完全一致。",

  "WHY P0 HAS TWO ONE-SIDED ROLES": "为什么 P0 具有两个单侧角色",
  "The side on which P0 appears changes the statement.": "P0 所在的一侧不同，数学命题也不同。",
  "For STAR at every nondegenerate level n≥2, P0 is a left zero and a right-neutral element. These are two precise one-sided properties, not a two-sided identity.":
    "对于每个非退化层级 n≥2 的 STAR，P0 是左零元，也是右中性元。这是两个精确的单侧性质，并不构成双侧单位元。",
  "P0 on the left": "P0 位于左侧",
  "Left zero": "左零元",
  "Whatever appears on the right, a raw-left P0 forces the result to P0.":
    "无论右侧是什么，只要原始左操作数为 P0，结果就必定是 P0。",
  "P0 on the right": "P0 位于右侧",
  "Right-neutral element": "右中性元",
  "Placing P0 on the right leaves the raw-left pole unchanged.": "把 P0 放在右侧时，原始左操作数中的极保持不变。",
  "Why P0 is not a two-sided identity": "为什么 P0 不是双侧单位元",
  "The left identity law fails": "左单位律不成立",
  "A two-sided identity e would require e★x=x and x★e=x. P0 satisfies only the second equation.":
    "双侧单位元 e 必须同时满足 e★x=x 与 x★e=x；P0 只满足第二个等式。",
  "At the one-element level, P0★P0=P0, so left zero, right-neutral, two-sided zero, and two-sided identity collapse into the same single equation. Every statement for n≥2 must keep this degenerate exception separate.":
    "在单元素层级上，P0★P0=P0，因此左零元、右中性元、双侧零元和双侧单位元都归并为同一个等式。凡是关于 n≥2 的陈述，都必须把这一退化例外单独列出。",
  "Check your understanding: does right-neutral mean commutative?": "理解检查：右中性是否意味着运算可交换？",
  "No. At L3, P0★P1=P0 while P1★P0=P1. The different results directly prove that STAR is not commutative.":
    "不是。在 L3 中，P0★P1=P0，而 P1★P0=P1。两个结果不同，直接证明 STAR 不可交换。",
  ...
  Family: "动作族",
  "Operand placement": "操作数位置",
  "Direct calculation": "直接计算",
  "Plain meaning": "通俗含义",
  "Apply cyclic addition with the source in the table row.": "将源状态放在表格行中，并执行循环加法。",
  "Swap the semantic roles on the table axes. PLUS reaches the same target because PLUS is commutative.":
    "交换表格两轴上的语义角色。由于 PLUS 可交换，它仍到达同一目标。",
  "The source controls whether the STAR reset row is entered.": "源状态决定是否进入 STAR 的重置行。",
  "The active pole is placed on the left and therefore controls the STAR reset test.":
    "活动极被放在左侧，因此由它控制 STAR 的重置判定。",
  "Direct witness: PLUS_LEFT and PLUS_RIGHT reach the same P2 but remain different typed addresses. STAR_LEFT reaches P0 and STAR_RIGHT reaches P2 because the reset test follows the raw-left operand.":
    "直接见证：PLUS_LEFT 与 PLUS_RIGHT 都到达 P2，但仍是两个不同的类型化地址。STAR_LEFT 到达 P0，STAR_RIGHT 到达 P2，因为重置判定取决于原始左操作数。",

  "GUIDED TRANSITION LABORATORY": "引导式状态转换实验室",
  "Rebuild one transition from roles, formula, table, and canonical record.":
    "从角色、公式、表格和规范记录四个方面重建一次转换。",
  "Start with the L3 reset example, then change one control at a time. The explanation, formula channel, complete table, and record must continue to agree.":
    "先从 L3 重置示例开始，再逐次只改变一个控件。说明文字、公式通道、完整表格与记录必须始终一致。",
  "Change one input and watch every witness update.": "改变一个输入，观察所有核验见证同步更新。",
  "FORMULA-DERIVED": "FORMULA-DERIVED",
  "Beginner transition controls": "入门状态转换控件",
  "1. Choose how many local states exist": "1. 选择局部状态的数量",
  "2. Choose the transition family": "2. 选择状态转换族",
  "3. Choose the source state": "3. 选择源状态",
  "4. Choose the active pole": "4. 选择活动极",
  "Plain-language replay": "通俗语言推演",
  "Five small decisions produce one exact transition.": "五个小决定共同产生一次精确转换。",
  "L{level} contains exactly {count} allowed state labels: {states}.":
    "L{level} 恰好包含 {count} 个允许的状态标签：{states}。",
  "LEFT places source P{source} on the raw left and active P{active} on the raw right.":
    "LEFT 将源状态 P{source} 放在原始左侧，将活动极 P{active} 放在原始右侧。",
  "RIGHT places active P{active} on the raw left and source P{source} on the raw right.":
    "RIGHT 将活动极 P{active} 放在原始左侧，将源状态 P{source} 放在原始右侧。",
  "PLUS always adds the two indices and wraps around modulo {level}.": "PLUS 始终把两个指标相加，再按模 {level} 回绕。",
  "STAR sees P0 on the raw left, so the reset clause returns P0 immediately.":
    "STAR 在原始左侧看到 P0，因此重置分支立即返回 P0。",
  ...
  "Formula and complete table must agree": "公式与完整表格必须一致",
  "Formula channel": "公式通道",
  "Complete {operation} table at L{level}": "L{level} 的完整 {operation} 表",
  "This browser lab recomputes finite mathematics. It does not run the release engine, interpret natural language, issue an operational receipt, or learn.":
    "此浏览器实验室只重新计算有限数学。它不会运行发布引擎，不会解释自然语言，不会签发运行回执，也不会学习。",

  "WHERE THE NUMBER 560 COMES FROM": "数字 560 从何而来",
  "Count addresses first, laws second, and semantic role placements third.":
    "先数地址，再数运算律，最后数语义角色的放置方式。",
  "No statistical estimate is involved. The count is a complete finite enumeration across L1–L7, and each multiplication in the derivation has a different object-level meaning.":
    "这一计数不涉及任何统计估计，而是对 L1–L7 的完整有限枚举；推导中的每次乘法都对应不同对象层级的含义。",
  "Complete count ledger": "完整计数账本",
  "Object counted": "所计对象",
  Calculation: "计算",
  Count: "数量",
  "What the number means": "该数字的含义",
  "560 is not": "560 不是",
  "560 neurons": "560 个神经元",
  "560 concepts": "560 个概念",
  "560 learned skills": "560 项已学习技能",
  "560 meanings": "560 种语义",
  "560 units of intelligence": "560 个智能单位",
  "Why count LEFT and RIGHT separately when PLUS gives the same targets?":
    "既然 PLUS 得到相同目标，为什么仍要分别计数 LEFT 与 RIGHT？",
  "Because a typed coordinate records semantic roles, not only its numeric output. Two transitions may end at the same pole while carrying different source-active provenance and different compatibility obligations.":
    "因为类型化坐标记录的不只是数值输出，还包括语义角色。两次转换可以结束于同一个极，但拥有不同的 source-active 来源信息和不同的兼容性义务。",

  "FROM CELLS TO BRACKETED PROGRAMS": "从单元格到带括号的程序",
  "One cell is one step. A program is an explicit tree of steps.":
    "一个单元格表示一步；一个程序则是由这些步骤组成的显式树。",
  "The target of one cell may feed another cell. For PLUS the grouping does not change the result; for STAR it can. Therefore a list of operands is not a complete STAR program—the brackets are executable structure.":
    "一个单元格的目标可以作为另一个单元格的输入。对 PLUS 而言，分组方式不改变结果；对 STAR 而言，分组方式可能改变结果。因此，只有操作数列表并不能构成完整的 STAR 程序——括号本身就是可执行结构。",
  "Left-associated L3 program": "左结合的 L3 程序",
  "Right-associated L3 program": "右结合的 L3 程序",
  Nonassociative: "非结合",
  "Changing the brackets can change the result. The L3 calculations above are an exact counterexample to associativity.":
    "改变括号可能改变结果。上面的 L3 计算是结合律不成立的精确反例。",
  ...
  "At L3, multiplying indices by 2 swaps P1 and P2 while fixing P0. Recompute every PLUS and STAR cell after the swap: the operation tables retain the same structure.":
    "在 L3 中，把指标乘以 2 会交换 P1 与 P2，同时固定 P0。交换后重新计算每个 PLUS 与 STAR 单元格，运算表仍保持相同结构。",
  "L3 relabelling": "L3 重新标记",
  "This permutation is an automorphism because it is reversible and preserves both operations.":
    "这一置换是自同构，因为它可逆，并且保持两个运算。",
  "Orbit of one pole": "一个极的轨道",
  "P1 can be carried to P2 by an allowed symmetry. P0 forms its own orbit because every automorphism fixes it.":
    "允许的对称变换可以把 P1 送到 P2。P0 单独构成一个轨道，因为每个自同构都固定 P0。",
  "Stabilizer of P1": "P1 的稳定子",
  "Only the identity relabelling leaves P1 exactly where it is.": "只有恒等重新标记会让 P1 保持在原位。",
  "Identity fixes": "恒等变换固定",
  "Swap fixes": "交换变换固定",
  Average: "平均值",
  "Burnside consistency witness: direct inspection gives the two carrier orbits {P0} and {P1,P2}; averaging fixed points also gives two.":
    "伯恩赛德一致性见证：直接检查得到两个载体元素轨道 {P0} 与 {P1,P2}；对固定点数取平均也得到 2。",
  "What symmetry does not mean": "对称性不意味着什么",
  "Orbit membership does not make two records semantically identical and does not merge their provenance, permissions, evidence, or real-world consequences.":
    "属于同一轨道并不会使两条记录在语义上完全相同，也不会合并其来源、权限、证据或现实后果。",
  "Continue to the complete symmetry chapter": "继续阅读完整的对称性章节",

  "MAPS BETWEEN LEVELS": "层级之间的映射",
  "A shared pole name is not enough to move information lawfully between levels.":
    "仅有相同的极名称，不足以证明信息能够在层级之间合法传递。",
  "A homomorphism must preserve the declared operations. An embedding must additionally keep distinct source poles distinct. Operational transfer can require still more: provenance, alignment, loss, and authorization checks.":
    "同态必须保持所声明的运算；嵌入还必须保持不同的源状态彼此可区分。运行迁移可能要求更多检查，包括来源、对齐、信息损失和授权。",
  "nonzero embedding": "非零嵌入",
  "Both laws agree on the shown pair, and exhaustive checking covers every source pair and all four typed families.":
    "对于所示输入对，两个运算律的结果一致；穷尽检查还覆盖了全部源状态对和四个类型化动作族。",
  "same-name map fails": "同名映射失败",
  "There is no nonzero full-algebra embedding L3→L5. The zero homomorphism still exists, so saying ‘no morphism exists’ would be false.":
    "不存在从 L3 到 L5 的非零完整代数嵌入；但零同态仍然存在，因此说“完全不存在态射”是错误的。",
  "These archived morphism receipts belong to the compatibility and audit layer. The legacy morphism_v1 module is excluded from the current V4 runtime wheel and is not a current public API capability.":
    "这些已归档的态射回执属于兼容性与审计层。旧版 morphism_v1 模块已从当前 V4 运行时软件包中排除，并非当前公开 API 的能力。",
  ...
  "understand arbitrary natural-language observations": "理解任意自然语言观测",
  "run a persistent learned policy": "运行持续存在的已学习策略",
  "contain a trained World Atlas": "包含已训练的 World Atlas",
  "prove external operational gain or General AI": "证明外部运行增益或通用人工智能",
  "The mathematical composition chapter describes a formal programming model. It must not be presented as a current multi-step runtime capability until the operational contracts and receipts exist.":
    "数学中的复合章节描述的是形式化编程模型。在运行契约与回执真正存在之前，不得把它表述为当前已具备的多步运行能力。",
  "Current V4 finite scope ledger": "当前 V4 有限范围账本",
  Object: "对象",
  "Exact value": "精确值",
  Interpretation: "解释",
  "Formal typed catalogue": "形式化类型坐标目录",
  ...
  "Frontier per source pattern": "每个源模式的候选前沿",
  "Deterministically ordered candidates": "按确定性规则排序的候选项",
  "Accepted source patterns": "可接受的源模式",
  "Fixed patterns, not arbitrary text": "固定模式，而非任意文本",
  "Arity / route depth": "元数 / 路径深度",
  "Binary, one-step current contour": "当前为二元、单步运行范围",

  "HOW TO READ GALO EVIDENCE": "如何阅读 GALO 证据",
  "A PASS is meaningful only together with its exact contour and terminal witness.":
    "只有与精确验证范围和终端见证同时给出时，PASS 才具有明确含义。",
  "GALO separates mathematical derivation, executable tests, archive replay, operational evaluation, and open boundaries. Evidence from one layer does not automatically authorize a claim in another.":
    "GALO 将数学推导、可执行测试、档案重放、运行评估和开放边界彼此分开。某一层的证据不会自动授权另一层的声明。",
  "Current legal release status": "当前具有证据约束力的发布状态",
  "Fresh STATIC and FAST are session replays. The FULL result is stored release evidence and was not freshly replayed in this review.":
    "Fresh STATIC 与 FAST 是本次会话中的重放结果；FULL 结果属于已存储的发布证据，本次审阅没有重新执行 FULL。",
  "Inspect the complete evidence matrix": "检查完整证据矩阵",

  "PLAIN-LANGUAGE GLOSSARY": "通俗术语表",
  "Open a term for its intuitive meaning and exact mathematical contract.":
    "展开一个术语，即可查看其直观含义与精确数学契约。",
  "The plain explanation supports understanding; the formal line remains the authoritative definition.":
    "通俗说明用于帮助理解；形式化条目仍是具有约束力的定义。",

  "COMMON MISCONCEPTIONS": "常见误解",
  "Six tempting shortcuts—and the exact correction for each one.":
    "六种看似自然但并不严谨的简化，以及对每一种简化的精确纠正。",
  "CONTINUE AT YOUR DEPTH": "按所需深度继续阅读",
  "You now have the conceptual map. Choose the next verification layer.":
    "现在你已经掌握概念地图，可以选择下一层验证材料。",
  "Exact formal kernel": "精确形式化内核",
  "Tables, 560 coordinates, ranks, programs, and morphisms": "表格、560 个坐标、秩、程序与态射",
  "Academic symmetry": "学术对称性",
  "Automorphisms, orbits, stabilizers, and Burnside": "自同构、轨道、稳定子与伯恩赛德引理",
  "Release evidence": "发布证据",
  "Archive receipts, current runtime, and claim boundaries": "档案回执、当前运行时与声明边界",
  "End of beginner contour: finite mathematics is established and independently tested; persistent learning, a trained current Atlas, external operational gain, and General AI are not established.":
    "入门层到此结束：有限数学已经确立并通过独立测试；持续学习、当前已训练的 Atlas、外部运行增益和通用人工智能均未得到确立。",

  "Ordered input pairs for one law": "一种运算律的有序输入对",
  "Every row-column address for one binary operation across L1–L7.": "L1–L7 中一种二元运算的全部行列地址。",
  "Raw PLUS and STAR coordinates": "原始 PLUS 与 STAR 坐标",
  "The same addresses are evaluated once under PLUS and once under STAR.":
    "同一批地址分别在 PLUS 与 STAR 下各计算一次。",
  "Oriented typed coordinates": "带方向的类型化坐标",
  "Each raw law coordinate is recorded with LEFT or RIGHT source-active role placement.":
    "每个原始运算律坐标都按 LEFT 或 RIGHT 的 source-active 角色位置记录。",
  "Current active runtime coordinates": "当前运行时的活动坐标",
  ...
  "Membership, one-shot execution, process-local rollback, process-local revocation, and work accounting are recorded within the current scope.":
    "在当前范围内，成员资格、一次性执行、进程内回滚、进程内撤销和工作量核算均被记录。",
  "Adaptive World Atlas loop": "自适应 World Atlas 循环",
  "Persistent semantic state, partner-grounded evaluation, multi-step programs, and learning remain target architecture.":
    "持续语义状态、由合作方现实数据支撑的评估、多步程序与学习仍属于目标架构。",

  "Does the statement follow from the declared finite laws?": "该陈述是否由已声明的有限运算律推出？",
  "The 560-coordinate count and the role of P0 are exhaustively derivable.":
    "560 个坐标的计数以及 P0 的角色都可以通过穷尽推导得到。",
  "Did independent executable checks reproduce the derivation?": "独立的可执行检查是否重现了该推导？",
  ...
  "Fresh FULL was not run and CPython 3.13 was unavailable in the review session.":
    "本次审阅未运行 Fresh FULL，并且会话环境中没有可用的 CPython 3.13。",
  "Would the claim require external data or a stronger evaluator?": "该声明是否需要外部数据或更强的评估器？",
  "External operational gain and arbitrary free-text reasoning are not proven.":
    "外部运行增益和任意自由文本推理均未得到证明。",

  Carrier: "载体",
  "The complete finite set of allowed states at one level.": "某一层级允许使用的全部状态所组成的有限集合。",
  "Q_n={P0,…,P_(n−1)}.": "Q_n={P0,…,P_(n−1)}.",
  Pole: "极",
  "One named position inside a carrier.": "载体中的一个具名位置。",
  "P_i is identified with residue i modulo n for calculation.": "计算时，将 P_i 与模 n 的余数类 i 对应。",
  Level: "层级",
  "The choice of how many distinct local states are available.": "对可用局部状态数量的选择。",
  "L_n uses the n-element carrier Q_n; a larger n is not automatically better or more intelligent.":
    "L_n 使用含 n 个元素的载体 Q_n；更大的 n 并不自动意味着更好或更智能。",
  "Binary operation": "二元运算",
  "A rule that accepts two allowed states and returns one allowed state.": "接收两个允许状态并返回一个允许状态的规则。",
  "f:Q_n×Q_n→Q_n.": "f:Q_n×Q_n→Q_n.",
  "Modulo n": "模 n",
  "Wrap around to P0 after reaching n, like a finite dial.": "到达 n 后回绕至 P0，就像有限刻度盘一样。",
  "Indices differing by a multiple of n represent the same residue class.": "相差 n 的整数倍的指标表示同一个余数类。",
  "Cayley table": "凯莱表",
  "A complete lookup table for a finite binary operation.": "有限二元运算的完整查找表。",
  "Row is the left operand, column is the right operand, and the cell is the result.":
    "行表示左操作数，列表示右操作数，单元格表示结果。",
  PLUS: "PLUS",
  "Cyclic movement around the finite carrier.": "沿有限载体循环移动。",
  "PLUS_n(P_i,P_j)=P_((i+j) mod n); it forms the cyclic group C_n.":
    "PLUS_n(P_i,P_j)=P_((i+j) mod n)；该运算构成循环群 C_n。",
  STAR: "STAR",
  "A reset-sensitive cyclic rule: a left P0 resets; otherwise it follows PLUS.":
    "对重置敏感的循环规则：左侧为 P0 时重置，否则遵循 PLUS。",
  "STAR_n(P_i,P_j)=P0 when i=0 and P_((i+j) mod n) otherwise.":
    "当 i=0 时，STAR_n(P_i,P_j)=P0；否则为 P_((i+j) mod n)。",
  "An element that forces the result when it is placed on the left.": "当该元素位于左侧时，它会强制决定结果。",
  "P0★x=P0 for every x.": "P0★x=P0，对每个 x 均成立。",
  "An element that leaves the other input unchanged when placed on the right.":
    "当该元素位于右侧时，它使另一个输入保持不变。",
  "x★P0=x; this does not make P0 a two-sided identity.": "x★P0=x；这并不使 P0 成为双侧单位元。",
  "Source state": "源状态",
  "The state from which a typed transition begins.": "类型化转换所起始的状态。",
  "The source role is retained even when operand swapping gives the same numeric target.":
    "即使交换操作数后得到相同的数值目标，源状态这一角色仍被保留。",
  "Active pole": "活动极",
  "The second semantic input applied to the source.": "施加到源状态上的第二个语义输入。",
  "LEFT/RIGHT determines whether active occupies the raw right or left operand position.":
    "LEFT/RIGHT 决定活动极占据原始右操作数位置还是原始左操作数位置。",
  "Typed coordinate": "类型化坐标",
  "A complete address for one deterministic transition.": "一次确定性转换的完整地址。",
  "level:family:source:active, with a separately computed target.":
    "地址为 level:family:source:active，目标状态另行计算。",
  Composition: "复合",
  "Using the output of one transition as an input to the next.": "把一次转换的输出用作下一次转换的输入。",
  "For nonassociative STAR, the syntax tree or brackets are part of the program.":
    "对于非结合的 STAR，语法树或括号属于程序本身。",
  Automorphism: "自同构",
  "A reversible relabelling that leaves every declared rule unchanged.": "保持每条已声明规则不变的可逆重新标记。",
  "A bijection from an algebra to itself preserving its operations and named constants.":
    "代数到自身的双射，并保持其运算与具名常元。",
  Orbit: "轨道",
  "All coordinates reachable from one coordinate by allowed symmetries.":
    "在允许的对称变换下，从一个坐标可以到达的全部坐标。",
  "Orb(x)={g·x | g∈G}.": "Orb(x)={g·x | g∈G}.",
  Stabilizer: "稳定子",
  "The symmetries that leave one selected coordinate unchanged.": "使某个选定坐标保持不变的全部对称变换。",
  "Stab(x)={g∈G | g·x=x}.": "Stab(x)={g∈G | g·x=x}.",
  "Burnside's lemma": "伯恩赛德引理",
  "A second way to count symmetry classes by averaging fixed points.":
    "通过对固定点数取平均来计算对称类别数的第二种方法。",
  "|X/G|=(1/|G|)Σ_g |Fix(g)|.": "|X/G|=(1/|G|)Σ_g |Fix(g)|.",
  Homomorphism: "同态",
  "A map between levels that preserves the declared operations.": "保持已声明运算的层级间映射。",
  "It need not be injective; the zero homomorphism exists for every ordered level pair.":
    "它不必是单射；每个有序层级对之间都存在零同态。",
  "A structure-preserving map that keeps different source states different.":
    "保持结构并使不同源状态继续彼此可区分的映射。",
  "An injective homomorphism; nonzero A_n→A_m embeddings for n≥2 exist exactly when n divides m.":
    "嵌入是单射同态；当 n≥2 时，非零嵌入 A_n→A_m 当且仅当 n 整除 m 时存在。",
  Receipt: "回执",
  ...
  "BOUNDARY is a terminal status with a named missing condition or counterexample.":
    "BOUNDARY 是一种终端状态，必须指出缺失条件或反例。",

  "P0 is the identity of STAR.": "P0 是 STAR 的单位元。",
  "For n≥2, P0 is only right-neutral and only a left zero; STAR has no two-sided identity.":
    "当 n≥2 时，P0 仅为右中性元且仅为左零元；STAR 不存在双侧单位元。",
  "L7 is more intelligent than L3.": "L7 比 L3 更智能。",
  "A higher level only offers more local distinctions. Intelligence and task value require separate evidence.":
    "更高层级只提供更多局部区分；智能与任务价值需要独立证据。",
  "The 560 cells are concepts or neurons.": "这 560 个单元格就是概念或神经元。",
  "They are formal transition addresses. Semantics, memory, and learned parameters are separate object classes.":
    "它们是形式化转换地址；语义、记忆与已学习参数属于不同的对象类别。",
  "An orbit means several states are semantically identical.": "属于同一轨道意味着多个状态在语义上完全相同。",
  "An orbit records equivalence under one declared symmetry action; it does not merge meaning, provenance, or authority.":
    "轨道只记录在某个已声明对称作用下的等价性；它不会合并语义、来源或权限。",
  "There is no morphism from L3 to L5.": "不存在从 L3 到 L5 的态射。",
  "The zero homomorphism exists. What does not exist is a nonzero or injective full-algebra embedding.":
    "零同态存在；不存在的是非零或单射的完整代数嵌入。",
  "Verified finite mathematics proves learning or General AI.": "经过验证的有限数学已经证明了学习或通用人工智能。",
  "It proves only the finite claims inside its contract. Persistent learning and General AI remain unclaimed.":
    "它只证明契约范围内的有限命题；持续学习与通用人工智能仍未被声称。",
  "semantic inputs": "语义输入",
  "source, active": "源状态、活动极",
  orientation: "取向",
  "LEFT or RIGHT": "LEFT 或 RIGHT",
  "raw operands": "原始操作数",
  "row, column": "行、列",
  law: "运算律",
  "PLUS or STAR": "PLUS 或 STAR",
  output: "输出",
  target: "目标",
  source: "源状态",
  family: "族",
  active: "活动极",
  "row = source · column = active": "行 = 源状态 · 列 = 活动极",
  "row = active · column = source": "行 = 活动极 · 列 = 源状态",

  // Expanded beginner contour · object boundaries
  "GALO makes a finite local transition alphabet explicit enough to calculate, inspect, and replay.":
    "GALO 将有限的局部转换字母表显式化，使其可以被计算、检查和重放。",
  "A local pole is not the agent's complete world state. The target architecture may use typed coordinates as components of an explicit World Atlas, but the formal kernel alone is not a language model, trained memory, proof of intelligence, or truth certificate.":
    "局部极并不是智能体完整的世界状态。目标架构可以把类型化坐标用作显式 World Atlas 的组成部分，但形式化内核本身既不是语言模型，也不是已训练记忆、智能证明或真值证书。",
  "Object boundary ledger": "对象边界清单",
  "From a local pole to an execution witness: do not mix object classes.": "从局部极到执行见证：不要混淆不同对象类别。",
  "Layer / status": "层级 / 状态",
  "Exact form": "精确形式",
  "What it is": "它是什么",
  "What it is not": "它不是什么",
  "Typed transition coordinate": "类型化转换坐标",
  "One local state label inside one finite carrier.": "一个有限载体中的一个局部状态标签。",
  "Not a complete thought, world model, semantic concept, or global agent state.":
    "它不是完整思维、世界模型、语义概念或智能体的全局状态。",
  "One address that fixes a level, law family, and the semantic roles of both inputs.":
    "一个同时确定层级、运算律族以及两个输入语义角色的地址。",
  "Its target is calculated; its domain meaning and permission are separate contracts.":
    "其目标由计算得出；领域含义与权限属于另外的契约。",
  "Committed descriptor": "已提交描述符",
  "One member of the finite candidate universe committed by the release.": "版本所提交的有限候选全集中的一个成员。",
  "A descriptor may be non-executable and is not a learned concept or completed action.":
    "描述符可能不可执行，也不是已学习概念或已经完成的行动。",
  ...
  "Tower is project language for the indexed L1–L7 families. It does not mean that every neighboring level embeds into the next one.":
    "“塔”是项目对 L1–L7 指标族的称呼；它不表示每个相邻层级都能嵌入下一层级。",
  "PLUS family": "PLUS 族",
  ...
  // Operand roles, standard translations, and rank
  "Source is the local pole from which this typed transition begins. Active is the pole applied to that source. LEFT puts source on the raw left; RIGHT puts active on the raw left. These names describe interface roles, not a complete World Atlas state and not standard algebraic translation terminology.":
    "源状态是类型化转换开始时所在的局部极；活动极是施加到该源状态上的极。LEFT 把源状态放在原始左侧，RIGHT 把活动极放在原始左侧。这些名称描述的是接口角色，既不表示完整的 World Atlas 状态，也不是标准代数平移术语。",
  "Source-active role placement flow": "源状态—活动极角色放置流程",
  "raw left = source · raw right = active": "原始左操作数 = 源状态 · 原始右操作数 = 活动极",
  "raw left = active · raw right = source": "原始左操作数 = 活动极 · 原始右操作数 = 源状态",
  "STANDARD TRANSLATIONS AND RANK · L3 · active P2": "标准平移与秩 · L3 · 活动极 P2",
  "Fix the active pole and watch which outputs the source can reach.": "固定活动极，再观察源状态能够到达哪些输出。",
  "standard right translation": "标准右平移",
  "The reset row collapses two sources to P0, so one output is lost.":
    "重置行把两个源状态压缩到 P0，因此会少一个输出。",
  "standard left translation": "标准左平移",
  "A nonzero fixed left pole cycles through every L3 output, so no output is lost.":
    "固定在左侧的非零极会循环遍历 L3 的全部输出，因此不会丢失任何输出。",
  "Rank means the number of distinct outputs. The ABI name and the standard algebraic translation name point in opposite directions because the fixed active pole occupies the other operand slot.":
    "秩表示不同输出的数量。ABI 名称与标准代数平移名称方向相反，是因为固定的活动极占据了另一个操作数位置。",

  // Orbit bridge and independent symmetry accounting
  "FROM TWO L3 POLE ORBITS TO 224 TYPED ORBITS": "从 L3 的两个极轨道到 224 个类型化轨道",
  "The example above acts on three individual poles at L3. The whole-tower count acts on ordered source-active pairs, separately inside every level and every one of the four family fibres.":
    "上例的作用对象是 L3 的三个单独极。全塔计数的作用对象则是有序的源状态—活动极对，并且分别限制在每个层级及四个运算族纤维内部。",
  "Fibrewise orbit ledger from L1 through L7": "L1 至 L7 的逐纤维轨道清单",
  "Pole orbits": "极轨道",
  "Ordered-pair orbits": "有序对轨道",
  "Four-family typed orbits": "四个运算族的类型化轨道",
  "No orbit crosses a level or typed-family boundary": "任何轨道都不跨越层级或类型化运算族边界",
  "At L3 specifically there are two pole orbits, five ordered-pair orbits, and therefore twenty typed orbits. The number 18 is only a sum of seven local group orders, not one global 18-element group.":
    "具体到 L3，共有两个极轨道、五个有序对轨道，因此有二十个类型化轨道。数字 18 只是七个局部群阶数之和，并不是一个含 18 个元素的全局群。",
  "Local L3 carrier witness: direct inspection gives the two pole orbits {P0} and {P1,P2}; averaging fixed poles also gives two.":
    "L3 局部载体见证：直接检查得到两个极轨道 {P0} 与 {P1,P2}；对固定极数量取平均同样得到 2。",
  "Whole-tower consistency witness: independent direct pair-orbit traversal and the Burnside fixed-point formula both reconstruct 224 typed orbits.":
    "全塔一致性见证：独立的有序对轨道遍历与伯恩赛德固定点公式均重建出 224 个类型化轨道。",

  // Cross-level theorem and exact compatibility boundary
  "The direct receipt rejects this same-index candidate. A separate order argument below rules out every nonzero full-algebra embedding L3→L5. The zero homomorphism still exists, so saying ‘no morphism exists’ would be false.":
    "直接回执否决了这一同指标候选映射。下方独立的阶数论证排除了所有非零完整代数嵌入 L3→L5。零同态仍然存在，因此说“完全不存在态射”是错误的。",
  "COMPATIBILITY_ONLY:": "COMPATIBILITY_ONLY:",
  "INDEPENDENT EMBEDDING THEOREM · n≥2": "独立嵌入定理 · n≥2",
  "A nonzero embedding A_n→A_m exists exactly when n divides m.": "非零嵌入 A_n→A_m 当且仅当 n 整除 m 时存在。",
  "PLUS preservation makes the image of the generator determine the entire map.":
    "保持 PLUS 使生成元的像决定整个映射。",
  ...
  // Current deterministic selector versus the target architecture
  "Current V4 descriptor arithmetic": "当前 V4 描述符算术",
  "The release counts are derived in this order": "版本计数按以下顺序推导",
  Value: "数值",
  "Independent arithmetic": "独立算术核对",
  ...
  "CURRENT V4 · EXACT REPLAYABLE PIPELINE": "CURRENT V4 · 精确可重放管线",
  "Match one fixed source pattern": "匹配一个固定源模式",
  "Only two exact closed patterns are accepted; arbitrary free text is outside this selector contract.":
    "只接受两个精确的封闭模式；任意自由文本不属于此选择器契约。",
  "Enter the committed universe": "进入已提交全集",
  "Every candidate must already belong to the finite release commitment.":
    "每个候选项都必须预先属于版本的有限提交集合。",
  "Filter executable kinds": "筛选可执行类型",
  "The executable ontology is limited to FREE_FRAME, JOINT_COMPOSITION, PROBE, and ROUTE.":
    "可执行本体仅限 FREE_FRAME、JOINT_COMPOSITION、PROBE 和 ROUTE。",
  "Choose a parity frontier": "选择奇偶前沿",
  "The recognized source pattern selects one half of the executable enumeration.":
    "识别出的源模式从可执行枚举中选择其中一半。",
  "Derive a deterministic order": "导出确定性次序",
  "The hash order is replayable; Atlas semantic reads, rank effects, and learning writes are all zero.":
    "哈希次序可以重放；Atlas 语义读取、排序影响和学习写入均为 0。",
  "Bind a one-shot handle": "绑定一次性句柄",
  "The selected candidate is bound to one process-local execution contour.": "所选候选项被绑定到一个进程内执行范围。",
  "Execute one bounded action": "执行一个有边界行动",
  "Current V4 does not execute the formal multi-step program trees described in the mathematics chapter.":
    "当前 V4 不执行数学章节所描述的形式化多步程序树。",
  "Record the receipt": "记录回执",
  "The receipt supports bounded replay and accounting; it does not measure external gain or truth.":
    "该回执支持有边界重放和记账；它不衡量外部增益或真实性。",
  "Source-pattern rule": "源模式规则",
  "Executable kinds": "可执行类型",
  "Atlas effects": "Atlas 影响",
  "COMPATIBILITY HISTORY:": "兼容性历史：",
  "Current sequencing, rollback, and revocation evidence is process-local; it does not establish durable trust state across restarts.":
    "当前的序列控制、回滚与撤销证据仅限进程内；它不能确立跨重启的持久可信状态。",
  "Persistent trusted manifest head": "持久化可信清单头",
  "Python process capability isolation": "Python 进程能力隔离",
  "The release checks typed admission and receipts, but they do not prove operating-system capability isolation for the Python process.":
    "该版本检查类型化准入与回执，但并未证明 Python 进程具备操作系统层面的能力隔离。",

  "TARGET ARCHITECTURE · NOT CURRENT V4": "目标架构 · 非 CURRENT V4",
  ...
  "Declare how domain objects and alternatives map into local finite coordinates without assigning universal pole meanings.":
    "声明领域对象及其备选解释如何映射到局部有限坐标，同时不为各极赋予普遍含义。",
  "Persistent World Atlas": "持久化 World Atlas",
  "Maintain explicit objects, events, competing hypotheses, evidence, and local revisions across time.":
    "跨时间维护显式的对象、事件、竞争性假设、证据与局部修正。",
  "Choose the smallest level that retains every task-relevant distinction for the current decision.":
    "选择能够保留当前决策所需全部任务相关区分的最小层级。",
  "Explicit ProgramIR": "显式 ProgramIR",
  "Compile a bracketed, typed, auditable multi-step program rather than an unstructured action list.":
    "编译带括号、类型化且可审计的多步程序，而不是无结构的行动列表。",
  "Authorized action": "获授权行动",
  "Require policy, provenance, capability, budget, and rollback contracts before real execution.":
    "在真实执行之前，要求策略、来源、能力、预算和回滚契约全部成立。",
  "Externally grounded outcome": "外部落地结果",
  "Use a preregistered evaluator to measure whether the action helped outside the internal receipt ledger.":
    "使用预注册评估器，衡量行动是否在内部回执账本之外产生了帮助。",
  "Local revision and policy update": "局部修正与策略更新",
  "Revise only affected hypotheses and authorize learning only after the evidence and evaluation gates close.":
    "只修正受影响的假设，并且仅在证据与评估门槛闭合后才授权学习。",

  // Symbol legend and updated exact definitions
  "Mathematical symbol legend": "数学符号图例",
  "How to read the symbols used in this chapter": "如何读懂本章使用的符号",
  Symbol: "符号",
  "Read aloud": "读作",
  "Meaning here": "在本章中的含义",
  "Q sub n": "Q 下标 n",
  "The complete n-element carrier at level L_n.": "层级 L_n 上含 n 个元素的完整载体。",
  "P sub i": "P 下标 i",
  "The pole whose calculation index is i modulo n.": "计算指标为模 n 余数 i 的极。",
  "the size of X": "X 的大小",
  "The number of elements in a finite set X.": "有限集合 X 的元素个数。",
  sum: "求和",
  "Add the indicated quantity over every stated index.": "对所有指定指标把所示数量相加。",
  "modulo n": "模 n",
  "Keep the remainder after division by n; this creates wraparound.": "保留除以 n 后的余数，由此产生循环回绕。",
  "f maps X to Y": "f 将 X 映射到 Y",
  "A function assigning each input in X exactly one output in Y.":
    "一个函数，为 X 中的每个输入恰好指定 Y 中的一个输出。",
  "is isomorphic to": "同构于",
  "The structures have the same form under a reversible structure-preserving map.":
    "在可逆且保持结构的映射下，这些结构具有相同形式。",
  sigma: "西格玛",
  "A relabelling map; here it normally denotes an automorphism.": "重新标记映射；在本章中通常表示自同构。",
  "units modulo n": "模 n 的单位元",
  "Indices u with gcd(u,n)=1; multiplication by u gives the allowed pointed relabellings.":
    "满足 gcd(u,n)=1 的指标 u；乘以 u 给出允许的保指定点重新标记。",
  "orbit of x": "x 的轨道",
  "Every object reachable from x under the declared group action.": "在已声明群作用下从 x 可以到达的每个对象。",
  "stabilizer of x": "x 的稳定子",
  "Every group element that leaves x fixed.": "使 x 保持不变的每个群元素。",
  ...
  "All acted-on objects reachable from one selected object by allowed symmetries.":
    "在允许的对称变换下，从一个选定对象可以到达的所有受作用对象。",
  "The symmetries that leave one selected acted-on object unchanged.": "使一个选定受作用对象保持不变的全部对称变换。",
