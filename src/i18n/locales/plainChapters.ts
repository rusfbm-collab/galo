...
export const plainChaptersAr: TranslationDictionary = {
  ...
  "Pick a level and a renaming, and watch which positions it groups together.": "اختر مستوىً وإعادة تسمية، وانظر أيّ المواضع تجمعها معًا.",
  ...
  "Three further boundary cases — how the shapes behave under the square residues, where the level-six decomposition stops applying, and what a phase label does and does not mean — are stated in the formal kernel chapter rather than here, because each needs vocabulary this page has deliberately not introduced.": "ثلاث حالات حدّية أخرى — كيف تتصرّف الأشكال تحت البواقي التربيعية، وأين يتوقّف تفكيك المستوى السادس عن الانطباق، وما الذي تعنيه بطاقة الطور وما لا تعنيه — مذكورة في فصل النواة الصوري لا هنا، لأنّ كلًاّ منها يحتاج مفردات لم تُدخِلها هذه الصفحة عن قصد.",
